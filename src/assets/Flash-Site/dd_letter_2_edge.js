         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'ee_txt',
                  type:'text',
                  rect:['37px','19px','auto','100px','auto','auto'],
                  text:"&lt;",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',125,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
               }]
            },
            {
               ...
               },
               {
                  id:'e_txt',
                  type:'text',
                  rect:['18px','18px','auto','100px','auto','auto'],
                  text:",",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ahh_txt',
                  type:'text',
                  rect:['5px','12px','auto','100px','auto','auto'],
                  text:"M",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ah_txt',
                  type:'text',
                  rect:['14px','12px','auto','100px','auto','auto'],
                  text:"m",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',105,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'aee_txt',
                  type:'text',
                  rect:['26px','13px','auto','100px','auto','auto'],
                  text:"V",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ae_txt',
                  type:'text',
                  rect:['28px','12px','auto','100px','auto','auto'],
                  text:"v",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',120,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'ouu_txt',
                  type:'text',
                  rect:['5px','19px','auto','100px','auto','auto'],
                  text:"C",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ou_txt',
                  type:'text',
                  rect:['7px','17px','auto','100px','auto','auto'],
                  text:"c",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',115,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid426", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid432", tween: [ "style", "${_header}", "font-size", '38px', { fromValue: '38px'}], position: 23418, duration: 0 },
            ...
            { id: "eid435", tween: [ "style", "${_header}", "width", '870px', { fromValue: '870px'}], position: 1613, duration: 0 },
            { id: "eid436", tween: [ "style", "${_header}", "width", '870px', { fromValue: '870px'}], position: 23418, duration: 0 },
            ...
            { id: "eid438", tween: [ "style", "${_pupils}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid437", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'none'}], position: 331, duration: 0, easing: "easeOutExpo" },
