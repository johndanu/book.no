   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid277", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid275", tween: [ "style", "${_wrapper}", "left", '32px', { fromValue: '32px'}], position: 0, duration: 0 },
            { id: "eid265", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid171", tween: [ "style", "${_menu_wrapper}", "left", '219px', { fromValue: '219px'}], position: 0, duration: 0 },
            { id: "eid278", tween: [ "style", "${_header}", "left", '119px', { fromValue: '119px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
