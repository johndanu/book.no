         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'ee_txt',
                  type:'text',
                  rect:['36px','16px','auto','100px','auto','auto'],
                  text:"&lt;",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'e_txt',
                  type:'text',
                  rect:['19px','20px','auto','100px','auto','auto'],
                  text:",",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ahh_txt',
                  type:'text',
                  rect:['3px','8px','auto','100px','auto','auto'],
                  text:"M",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ah_txt',
                  type:'text',
                  rect:['7px','8px','auto','100px','auto','auto'],
                  text:"m",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',110,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'aee_txt',
                  type:'text',
                  rect:['27px','8px','auto','100px','auto','auto'],
                  text:"V",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'ae_txt',
                  type:'text',
                  rect:['32px','6px','auto','100px','auto','auto'],
                  text:"v",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',120,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'ouu_txt',
                  type:'text',
                  rect:['9px','15px','auto','100px','auto','auto'],
                  text:"C",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',110,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'ou_txt',
                  type:'text',
                  rect:['12px','13px','auto','100px','auto','auto'],
                  text:"c",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',110,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid425", tween: [ "style", "${_vilayattu2}", "top", '-144px', { fromValue: '-592px'}], position: 95, duration: 831 },
            { id: "eid426", tween: [ "style", "${_vilayattu2}", "top", '-174px', { fromValue: '-144px'}], position: 926, duration: 250 },
            ...
            { id: "eid422", tween: [ "style", "${_vilayattu2}", "left", '20px', { fromValue: '20px'}], position: 95, duration: 0 },
