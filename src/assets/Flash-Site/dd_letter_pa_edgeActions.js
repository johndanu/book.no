...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_letter3}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_letter4}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_letter5}", "click", function(sym, e) {
