...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "kokku.mp3|" + assetsPath + "kokku.ogg", id: "pic1"},
         
                                                {src: assetsPath + "koli.mp3|" + assetsPath + "koli.ogg", id: 'pic2'},
         
                                                {src: assetsPath + "oadatham.mp3|" + assetsPath + "oadatham.ogg", id: 'pic3'},
         
                                                {src: assetsPath + "kodi.mp3|" + assetsPath + "kodi.ogg", id: 'pic4'},
         
                                                {src: assetsPath + "kouthari.mp3|" + assetsPath + "kouthari.ogg", id: 'pic5'},
         													{src: assetsPath + "thoppi.mp3|" + assetsPath + "thoppi.ogg", id: 'pic6'},
         
         
         													{src: assetsPath + "kovil.mp3|" + assetsPath + "kovil.ogg", id: 'pic7'},
         													{src: assetsPath + "vavval.mp3|" + assetsPath + "vavval.ogg", id: 'pic8'},
         
         													{src: assetsPath + "thodu.mp3|" + assetsPath + "thodu.ogg", id: 'pic9'},
         
         
                                                {src: assetsPath + "kolam.mp3|" + assetsPath + "kolam.ogg", id: 'pic10'},
                                                {src: assetsPath + "kodu.mp3|" + assetsPath + "kodu.ogg", id: 'pic11'},
                                                {src: assetsPath + "pongal.mp3|" + assetsPath + "pongal.ogg", id: 'pic12'},
                                                {src: assetsPath + "mottu.mp3|" + assetsPath + "mottu.ogg", id: 'pic13'},
                                                {src: assetsPath + "oavayar.mp3|" + assetsPath + "oavayar.ogg", id: 'pic14'},
                                                {src: assetsPath + "bommai.mp3|" + assetsPath + "bommai.ogg", id: 'pic15'},
                                                {src: assetsPath + "tholi.mp3|" + assetsPath + "tholi.ogg", id: 'pic16'},
                                                {src: assetsPath + "soru.mp3|" + assetsPath + "soru.ogg", id: 'pic17'},
                                                {src: assetsPath + "komali.mp3|" + assetsPath + "komali.ogg", id: 'pic18'},
                                                {src: assetsPath + "tholan.mp3|" + assetsPath + "tholan.ogg", id: 'pic19'},
                                                {src: assetsPath + "thottil.mp3|" + assetsPath + "thottil.ogg", id: 'pic20'},
         ...
         sym.setVariable("myques",['nfhf;F','Nfhop',"xsljk;",'nfhb','nfsjhhp','njhg;gp','Nfhapy;','ntsthy;','NjhL','Nfhyk;','NfhL','nghq;fy;','nkhl;L','xsitahh;','nghk;ik','Njhop','NrhW','Nfhkhsp','Njhod;','njhl;by;']);
         sym.setVariable("myopt",['r1','r2',"r3",'r1','r3',"r1",'r2','r3',"r2",'r2','r2',"r1",'r1','r3',"r1",'r2','r2',"r2",'r2','r1']);
