         ...
         },
         {
            ...
            },
            {
               ...
               },
               {
                  id:'ma_txt',
                  type:'text',
                  rect:['25px','14px','auto','100px','auto','auto'],
                  text:"k",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'va_txt',
                  type:'text',
                  rect:['13px','9px','auto','100px','auto','auto'],
                  text:"t",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'na_txt',
                  type:'text',
                  rect:['32px','8px','auto','100px','auto','auto'],
                  text:"e",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid434", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'none'}], position: 331, duration: 0, easing: "easeOutExpo" },
            ...
            { id: "eid397", tween: [ "style", "${_header}", "font-size", '38px', { fromValue: '38px'}], position: 1750, duration: 0 },
            ...
            { id: "eid394", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            ...
            { id: "eid395", tween: [ "style", "${_header}", "width", '959px', { fromValue: '959px'}], position: 1750, duration: 0 },
