...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "sa.mp3|" + assetsPath + "sa.ogg", id: "pic1"},
         
                                  {src: assetsPath + "saa.mp3|" + assetsPath + "saa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "si.mp3|" + assetsPath + "si.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "see.mp3|" + assetsPath + "see.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "su.mp3|" + assetsPath + "su.ogg", id: 'pic5'},
         								 {src: assetsPath + "soo.mp3|" + assetsPath + "soo.ogg", id: 'pic6'},
                                  {src: assetsPath + "se.mp3|" + assetsPath + "Se.ogg", id: 'pic7'},
                                  {src: assetsPath + "sea.mp3|" + assetsPath + "sea.ogg", id: 'pic8'},
                                  {src: assetsPath + "sai.mp3|" + assetsPath + "Sai.ogg", id: 'pic9'},
                                  {src: assetsPath + "sai.mp3|" + assetsPath + "Sai.ogg", id: 'pic9'},
                                  {src: assetsPath + "so.mp3|" + assetsPath + "so.ogg", id: 'pic10'},
                                  {src: assetsPath + "sso.mp3|" + assetsPath + "sso.ogg", id: 'pic11'},
                                  {src: assetsPath + "sov.mp3|" + assetsPath + "sov.ogg", id: 'pic12'},
      ...
      Symbol.bindElementAction(compId, symbolName, "${_a}", "mousedown", function(sym, e) {
         var X = sym.$(".a").offset().left;
         var Y = sym.$(".a").offset().top;
