         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "suriyakanthi.mp3|" + assetsPath + "suriyakanthi.ogg", id: "oo_pic1"},
         
                                                {src: assetsPath + "oothal.mp3|" + assetsPath + "oothal.ogg", id: 'oo_pic2'},
         
                                                {src: assetsPath + "oosi.mp3|" + assetsPath + "oosi.ogg", id: 'oo_pic3'},
         
                                                {src: assetsPath + "oonjal.mp3|" + assetsPath + "oonjal.ogg", id: 'oo_pic4'},
                                                {src: assetsPath + "udha.mp3|" + assetsPath + "udha.ogg", id: 'oo_pic5'},
         
                                                {src: assetsPath + "oorvalam.mp3|" + assetsPath + "oorvalam.ogg", id: 'oo_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/oo_pic1.png)","url(images/oo_pic2.png)","url(images/oo_pic3.png)",
      						"url(images/oo_pic4.png)","url(images/oo_pic5.png)","url(images/oo_pic6.png)"];
