         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "la.mp3|" + assetsPath + "la.ogg", id: "pic1"},
         
                                  {src: assetsPath + "laa.mp3|" + assetsPath + "laa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "li.mp3|" + assetsPath + "li.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "lee.mp3|" + assetsPath + "lee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "lu.mp3|" + assetsPath + "lu.ogg", id: 'pic5'},
         								 {src: assetsPath + "loo.mp3|" + assetsPath + "loo.ogg", id: 'pic6'},
                                  {src: assetsPath + "le.mp3|" + assetsPath + "le.ogg", id: 'pic7'},
                                  {src: assetsPath + "lea.mp3|" + assetsPath + "lea.ogg", id: 'pic8'},
                                  {src: assetsPath + "lai.mp3|" + assetsPath + "lai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "lo.mp3|" + assetsPath + "lo.ogg", id: 'pic10'},
                                  {src: assetsPath + "lmo.mp3|" + assetsPath + "lvo.ogg", id: 'pic11'},
                                  {src: assetsPath + "lov.mp3|" + assetsPath + "lov.ogg", id: 'pic12'},
