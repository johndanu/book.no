...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['498','228px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['436px','126px','659px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['272px','126px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            },
            {
               id:'wrd3',
               type:'text',
               rect:['433px','7px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"efuk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['273px','7px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"efk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['93px','10px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"eldk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid64", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_padangal}", "left", '295px', { fromValue: '295px'}], position: 0, duration: 0 },
            { id: "eid74", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1016, duration: 0 },
            { id: "eid63", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid70", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1016, duration: 0 },
            { id: "eid60", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid65", tween: [ "style", "${_words}", "left", '529px', { fromValue: '529px'}], position: 0, duration: 0 },
            { id: "eid62", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid73", tween: [ "style", "${_star}", "top", '-49px', { fromValue: '-49px'}], position: 1016, duration: 0 },
            ...
            { id: "eid72", tween: [ "style", "${_star}", "left", '-177px', { fromValue: '-177px'}], position: 1016, duration: 0 },
            { id: "eid66", tween: [ "style", "${_words}", "top", '775px', { fromValue: '775px'}], position: 0, duration: 0 },
            { id: "eid71", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1016, duration: 0 },
