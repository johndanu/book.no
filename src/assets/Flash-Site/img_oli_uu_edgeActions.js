...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oothal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oothal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oonjal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oonjal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oosi}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oosi');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oorvalam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oorvalam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oothal}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oothal}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oonjal}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oorvalam}", "mouseover", function(sym, e) {
         sym.play("on_4");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_oosi}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_oosi}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_oonjal}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_oorvalam}", "mouseout", function(sym, e) {
         sym.stop("off_4");
