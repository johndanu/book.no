         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "nga.mp3|" + assetsPath + "nga.ogg", id: "pic1"},
         
                                  {src: assetsPath + "ngaa.mp3|" + assetsPath + "ngaa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "ngi.mp3|" + assetsPath + "ngi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "ngee.mp3|" + assetsPath + "ngee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "ngu.mp3|" + assetsPath + "ngu.ogg", id: 'pic5'},
         								 {src: assetsPath + "ngoo.mp3|" + assetsPath + "ngoo.ogg", id: 'pic6'},
                                  {src: assetsPath + "nge.mp3|" + assetsPath + "nge.ogg", id: 'pic7'},
                                  {src: assetsPath + "ngea.mp3|" + assetsPath + "ngea.ogg", id: 'pic8'},
                                  {src: assetsPath + "ngai.mp3|" + assetsPath + "ngai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "ngo.mp3|" + assetsPath + "ngo.ogg", id: 'pic10'},
                                  {src: assetsPath + "nngo.mp3|" + assetsPath + "nngo.ogg", id: 'pic11'},
                                  {src: assetsPath + "ngov.mp3|" + assetsPath + "ngov.ogg", id: 'pic12'},
