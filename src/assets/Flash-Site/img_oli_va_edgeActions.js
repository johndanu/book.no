...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vannam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('vannam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_valam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('valam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vayal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('vayal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vannam}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vannam}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_valam}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vayal}", "mouseover", function(sym, e) {
         sym.play("on_4");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_valam}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_vayal}", "mouseout", function(sym, e) {
         sym.stop("off_4");
