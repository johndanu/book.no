...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'wrapper',
            type:'image',
            rect:['-2px','59px','1370px','649px','auto','auto'],
         ...
         },
         {
            ...
            },
            {
               id:'rights',
               type:'text',
               rect:['47.9%','50.5%','60.5%','13.3%','auto','auto'],
               opacity:1,
         ...
         },
         {
            id:'menu_wrapper',
            type:'image',
            rect:['221px','2px','1055px','717px','auto','auto'],
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['437px','134px','813px','17px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['260px','131px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            },
            {
               ...
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['87px','195px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['96px','188px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['25px','191px','auto','auto','auto','auto'],
                  text:"v . J",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['62px','196px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['71px','189px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
         ...
         },
         {
            id:'fct',
            type:'group',
            rect:['74px','710px','227','28','auto','auto'],
            c:[
            {
               id:'fct_2',
               type:'group',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid64", tween: [ "style", "${_ansbox3}", "top", '196px', { fromValue: '196px'}], position: 0, duration: 0 },
            { id: "eid66", tween: [ "style", "${_letters}", "top", '501px', { fromValue: '501px'}], position: 0, duration: 0 },
            { id: "eid62", tween: [ "style", "${_padangal}", "top", '222px', { fromValue: '222px'}], position: 0, duration: 0 },
            { id: "eid63", tween: [ "style", "${_answrd3}", "top", '195px', { fromValue: '195px'}], position: 0, duration: 0 },
            { id: "eid65", tween: [ "style", "${_fill_line3}", "top", '189px', { fromValue: '189px'}], position: 0, duration: 0 },
            ...
            { id: "eid67", tween: [ "style", "${_letters}", "left", '364px', { fromValue: '364px'}], position: 0, duration: 0 },
            { id: "eid52", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid60", tween: [ "style", "${_fill_line3}", "left", '74px', { fromValue: '104px'}], position: 0, duration: 13 },
            ...
            { id: "eid56", tween: [ "style", "${_answrd3}", "left", '32px', { fromValue: '62px'}], position: 0, duration: 13 },
            { id: "eid50", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid58", tween: [ "style", "${_ansbox3}", "left", '65px', { fromValue: '95px'}], position: 0, duration: 13 },
            { id: "eid79", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
