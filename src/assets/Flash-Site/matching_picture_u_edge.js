...
"gameBoard": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid19", tween: [ "style", "${_flower5}", "left", '243px', { fromValue: '243px'}], position: 0, duration: 0 },
            { id: "eid21", tween: [ "style", "${_flower4}", "left", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
            { id: "eid477", tween: [ "transform", "${_flower8}", "scaleY", '3.373', { fromValue: '3.373'}], position: 0, duration: 0 },
            { id: "eid23", tween: [ "style", "${_flower9}", "left", '243px', { fromValue: '243px'}], position: 0, duration: 0 },
            ...
            { id: "eid26", tween: [ "style", "${_flower0}", "left", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
            ...
            { id: "eid24", tween: [ "style", "${_flower2}", "left", '418px', { fromValue: '418px'}], position: 0, duration: 0 },
            ...
            { id: "eid13", tween: [ "style", "${_flower6}", "left", '418px', { fromValue: '418px'}], position: 0, duration: 0 },
            { id: "eid472", tween: [ "transform", "${_flower5}", "scaleX", '3.373', { fromValue: '3.373'}], position: 0, duration: 0 },
            { id: "eid25", tween: [ "style", "${_flower3}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
            ...
            { id: "eid20", tween: [ "style", "${_flower7}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
            ...
            { id: "eid14", tween: [ "style", "${_flower10}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
