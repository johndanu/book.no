   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid125", tween: [ "style", "${_TextCopy8}", "left", '75px', { fromValue: '75px'}], position: 0, duration: 0 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid122", tween: [ "style", "${_TextCopy6}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
