   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid184", tween: [ "style", "${_vilayatu}", "top", '-183px', { fromValue: '-445px'}], position: 30000, duration: 0 },
            ...
            { id: "eid756", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'none'}], position: 4587, duration: 0, easing: "easeOutExpo" },
            { id: "eid762", tween: [ "style", "${_pupils}", "display", 'none', { fromValue: 'block'}], position: 6185, duration: 0 },
