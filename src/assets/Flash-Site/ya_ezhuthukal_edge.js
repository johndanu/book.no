...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid267", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            ...
            { id: "eid266", tween: [ "style", "${_question}", "left", '737px', { fromValue: '737px'}], position: 0, duration: 0 },
