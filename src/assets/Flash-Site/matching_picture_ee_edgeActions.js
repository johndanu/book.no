         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "eesal.mp3|" + assetsPath + "eesal.ogg", id: "ee_pic1"},
         
                                                {src: assetsPath + "eeram.mp3|" + assetsPath + "eeram.ogg", id: 'ee_pic2'},
         
                                                {src: assetsPath + "eeyam.mp3|" + assetsPath + "eeyam.ogg", id: 'ee_pic3'},
         
                                                {src: assetsPath + "neelam.mp3|" + assetsPath + "neelam.ogg", id: 'ee_pic4'},
         
                                                {src: assetsPath + "vetti.mp3|" + assetsPath + "vetti.ogg", id: 'ee_pic5'},
         
                                                {src: assetsPath + "veenai.mp3|" + assetsPath + "veenai.ogg", id: 'ee_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/ee_pic1.png)","url(images/ee_pic2.png)","url(images/ee_pic3.png)",
      						"url(images/ee_pic4.png)","url(images/ee_pic5.png)","url(images/ee_pic6.png)"];
