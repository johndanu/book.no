         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "ta.mp3|" + assetsPath + "ta.ogg", id: "pic1"},
         
                                  {src: assetsPath + "taa.mp3|" + assetsPath + "taa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "ti.mp3|" + assetsPath + "ti.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "tee.mp3|" + assetsPath + "tee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "tu.mp3|" + assetsPath + "tu.ogg", id: 'pic5'},
         								 {src: assetsPath + "too.mp3|" + assetsPath + "too.ogg", id: 'pic6'},
                                  {src: assetsPath + "te.mp3|" + assetsPath + "te.ogg", id: 'pic7'},
                                  {src: assetsPath + "tea.mp3|" + assetsPath + "tea.ogg", id: 'pic8'},
                                  {src: assetsPath + "tai.mp3|" + assetsPath + "tai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "to.mp3|" + assetsPath + "to.ogg", id: 'pic10'},
                                  {src: assetsPath + "tto.mp3|" + assetsPath + "tto.ogg", id: 'pic11'},
                                  {src: assetsPath + "tov.mp3|" + assetsPath + "tov.ogg", id: 'pic12'},
