...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_innal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('innal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_inbam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('inbam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_illam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('illam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_innal}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_innal}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_inbam}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_illam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_illam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_inbam}", "mouseout", function(sym, e) {
         sym.stop("off_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pin2Copy2}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
         window.open("oli_2.html", "_self");
