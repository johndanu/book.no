...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_erumbu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('erumbu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_erumbu}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_erumbu}", "mouseout", function(sym, e) {
         sym.stop("off_2");
