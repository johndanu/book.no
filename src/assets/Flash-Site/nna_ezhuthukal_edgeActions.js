         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "__na.mp3|" + assetsPath + "__na.ogg", id: "pic1"},
         
                                  {src: assetsPath + "__naa.mp3|" + assetsPath + "__naa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "__ni.mp3|" + assetsPath + "__ni.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "__nee.mp3|" + assetsPath + "__nee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "__nu.mp3|" + assetsPath + "__nu.ogg", id: 'pic5'},
         								 {src: assetsPath + "__noo.mp3|" + assetsPath + "__noo.ogg", id: 'pic6'},
                                  {src: assetsPath + "__ne.mp3|" + assetsPath + "__ne.ogg", id: 'pic7'},
                                  {src: assetsPath + "__nea.mp3|" + assetsPath + "__nea.ogg", id: 'pic8'},
                                  {src: assetsPath + "__nai.mp3|" + assetsPath + "__nai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "__no.mp3|" + assetsPath + "__no.ogg", id: 'pic10'},
                                  {src: assetsPath + "__nno.mp3|" + assetsPath + "__nno.ogg", id: 'pic11'},
                                  {src: assetsPath + "__nov.mp3|" + assetsPath + "__nov.ogg", id: 'pic12'},
