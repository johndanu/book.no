...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
                  ...
                  function init()
                  	{
         				...
         				var drag = ["wrd1", "wrd2", "wrd3", "wrd4","wrd5"];
         				var drop = ["ans1", "ans2", "ans3", "ans4","ans5"];
         				var recta = ["rect1", "rect2", "rect3", "rect4","rect5"];
         				$mark = 0;
                  		//Draggable
         				...
         				for(i=0;i<drop.length;i++)
         				{
         						...
         						{	
									...
									//index of rect
									sym.$(recta[j]).css({"border-color":"#49f50c", "border-width":"3px"});
									//index of sound
      ...
      Symbol.bindElementAction(compId, symbolName, "${_wrd1}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_wrd2}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_wrd3}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound3');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_wrd4}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound4');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_wrd5}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound5');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_box3}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound3');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_box4}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound4');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_box5}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sound5');
         sound.play();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 962, function(sym, e) {
         sym.play("star");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_fct_2Copy}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
