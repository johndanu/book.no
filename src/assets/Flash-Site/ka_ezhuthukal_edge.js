...
var fonts = {};
   ...
   fonts['baamini']='';
   fonts['myfont']='<style type=\"text/css\">@font-face {  font-family: MyCustomFont2;  src: url(\'font/Baamini.ttf\'); /* Edit this line */}</style>';
...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            text:"f;",
            align:"left",
            font:['MyCustomFont2',70,"rgba(255,255,255,1)","bold","none","normal"]
         },
         {
            id:'quesText',
            type:'text',
         ...
         },
         {
            ...
            align:"left",
            userClass:"a",
            font:['MyCustomFont2',55,"rgba(255,255,255,1.00)","700","none",""]
         },
         {
            id:'aa',
            type:'text',
         ...
         },
         {
            ...
            align:"center",
            font:['MyCustomFont2',35,"rgba(253,123,22,1.00)","800","none","normal"]
         }],
         symbolInstances: [
         {
            id:'mystage',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid382", tween: [ "style", "${_quesText}", "font-size", '55px', { fromValue: '55px'}], position: 0, duration: 0 },
            { id: "eid436", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid463", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid171", tween: [ "style", "${_menu_wrapper}", "left", '219px', { fromValue: '219px'}], position: 0, duration: 0 },
            { id: "eid434", tween: [ "style", "${_wrapper}", "left", '44px', { fromValue: '44px'}], position: 0, duration: 0 },
            { id: "eid384", tween: [ "style", "${_Text3}", "font-size", '55px', { fromValue: '55px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
