...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid247", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid171", tween: [ "style", "${_menu_wrapper}", "left", '219px', { fromValue: '219px'}], position: 0, duration: 0 },
            { id: "eid248", tween: [ "style", "${_wrapper}", "left", '41px', { fromValue: '41px'}], position: 0, duration: 0 },
            { id: "eid241", tween: [ "style", "${_Text3}", "top", '374px', { fromValue: '374px'}], position: 0, duration: 0 },
            { id: "eid250", tween: [ "style", "${_quesText}", "top", '370px', { fromValue: '370px'}], position: 0, duration: 0 },
            { id: "eid242", tween: [ "style", "${_Text3}", "left", '480px', { fromValue: '480px'}], position: 0, duration: 0 },
            { id: "eid256", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
