...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['441px','116px','794px','17px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['262px','120px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['79px','332px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['-10px','195px','auto','auto','auto','auto'],
                  text:"Ch;t . k;",
                  align:"center",
               ...
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['106px','196px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['115px','189px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['4px','201px','auto','auto','auto','auto'],
                  text:"C . ry;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox3',
                  type:'rect',
                  rect:['61px','200px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line3',
                  type:'text',
                  rect:['70px','193px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['0px','200px','150px','47px','auto','auto'],
                  text:"C",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['102px','200px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['111px','193px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['15px','201px','auto','auto','auto','auto'],
                  text:"C . y;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['74px','200px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['84px','191px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['294px','40px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid52", tween: [ "style", "${_padangal}", "left", '300px', { fromValue: '300px'}], position: 56, duration: 0 },
            { id: "eid49", tween: [ "style", "${_letters}", "top", '773px', { fromValue: '773px'}], position: 56, duration: 0 },
            { id: "eid47", tween: [ "style", "${_letters}", "left", '466px', { fromValue: '466px'}], position: 56, duration: 0 },
            ...
            { id: "eid53", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 56, duration: 0 },
