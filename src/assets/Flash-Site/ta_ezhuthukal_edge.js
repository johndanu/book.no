...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               ...
               text:"vOj;Jf;fis fz;LgpLj;jy;<br><br>",
               align:"center",
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid287", tween: [ "style", "${_header}", "width", '565px', { fromValue: '565px'}], position: 0, duration: 0 },
            { id: "eid276", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid281", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid289", tween: [ "style", "${_header}", "top", '-5px', { fromValue: '-5px'}], position: 0, duration: 0 },
            { id: "eid187", tween: [ "style", "${_mystage}", "top", '114px', { fromValue: '114px'}], position: 0, duration: 0 },
            { id: "eid277", tween: [ "style", "${_wrapper}", "left", '36px', { fromValue: '36px'}], position: 0, duration: 0 },
            ...
            { id: "eid288", tween: [ "style", "${_header}", "left", '246px', { fromValue: '246px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
