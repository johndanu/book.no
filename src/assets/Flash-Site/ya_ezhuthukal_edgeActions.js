      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         setTimeout( function () {
         			//  alert("delay")
         				          ...
         				          sym.$('finish').show();
         			eluthukal_main_menu.htmlEC.Sound.play('clapping');
         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "ya.mp3|" + assetsPath + "ya.ogg", id: "pic1"},
         
                                  {src: assetsPath + "yaa.mp3|" + assetsPath + "yaa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "yi.mp3|" + assetsPath + "yi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "yee.mp3|" + assetsPath + "yee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "yu.mp3|" + assetsPath + "yu.ogg", id: 'pic5'},
         								 {src: assetsPath + "yoo.mp3|" + assetsPath + "yoo.ogg", id: 'pic6'},
                                  {src: assetsPath + "ye.mp3|" + assetsPath + "ye.ogg", id: 'pic7'},
                                  {src: assetsPath + "yea.mp3|" + assetsPath + "yea.ogg", id: 'pic8'},
                                  {src: assetsPath + "yai.mp3|" + assetsPath + "yai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "yo.mp3|" + assetsPath + "yo.ogg", id: 'pic10'},
                                  {src: assetsPath + "yyo.mp3|" + assetsPath + "yyo.ogg", id: 'pic11'},
                                  {src: assetsPath + "yov.mp3|" + assetsPath + "yov.ogg", id: 'pic12'},
