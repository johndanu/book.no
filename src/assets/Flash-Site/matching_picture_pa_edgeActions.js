   ...
   (function(symbolName) {
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         yepnope({
                  ...
                  var assetsPath = "all-sounds/";
         
                  EC.Sound.setup(
         
                             [
         
                                                {src: assetsPath + "pandhu.mp3|" + assetsPath + "pandhu.ogg", id: "pa_pic1"},
         
                                                {src: assetsPath + "pazham.mp3|" + assetsPath + "pazham.ogg", id: 'pa_pic2'},
         
                                                {src: assetsPath + "panam.mp3|" + assetsPath + "panam.ogg", id: 'pa_pic3'},
         
                                                {src: assetsPath + "baloon.mp3|" + assetsPath + "baloon.ogg", id: 'pa_pic4'},
         
                                                {src: assetsPath + "pal.mp3|" + assetsPath + "kan.ogg", id: 'pa_pic5'},
         
                                                {src: assetsPath + "bambaram.mp3|" + assetsPath + "bambaram.ogg", id: 'pa_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/pa_pic1.png)","url(images/pa_pic2.png)","url(images/pa_pic3.png)",
      						"url(images/pa_pic4.png)","url(images/pa_pic5.png)","url(images/pa_pic6.png)"];
