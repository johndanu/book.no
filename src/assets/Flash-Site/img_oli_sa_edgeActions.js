...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_saram}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('saram');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sattham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sattham');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sattam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sattam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_saram}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_saram}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sattham}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sattam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sattam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sattham}", "mouseout", function(sym, e) {
         sym.stop("off_3");
