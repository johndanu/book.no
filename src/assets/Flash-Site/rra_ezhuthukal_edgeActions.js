         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "_ra.mp3|" + assetsPath + "_ra.ogg", id: "pic1"},
         
                                  {src: assetsPath + "_raa.mp3|" + assetsPath + "_raa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "_ri.mp3|" + assetsPath + "_ri.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "_ree.mp3|" + assetsPath + "_ree.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "_ru.mp3|" + assetsPath + "_ru.ogg", id: 'pic5'},
         								 {src: assetsPath + "_roo.mp3|" + assetsPath + "_roo.ogg", id: 'pic6'},
                                  {src: assetsPath + "_re.mp3|" + assetsPath + "_re.ogg", id: 'pic7'},
                                  {src: assetsPath + "_rea.mp3|" + assetsPath + "_rea.ogg", id: 'pic8'},
                                  {src: assetsPath + "_rai.mp3|" + assetsPath + "_rai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "_ro.mp3|" + assetsPath + "_ro.ogg", id: 'pic10'},
                                  {src: assetsPath + "_rro.mp3|" + assetsPath + "_rro.ogg", id: 'pic11'},
                                  {src: assetsPath + "_rov.mp3|" + assetsPath + "_rov.ogg", id: 'pic12'},
