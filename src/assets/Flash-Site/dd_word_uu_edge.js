...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'wrapper',
            type:'image',
            rect:['0px','0px','1370px','941px','auto','auto'],
         ...
         },
         {
            id:'menu_wrapper',
            type:'image',
            rect:['221px','2px','1109px','840px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"menu_wrapper.png",'0px','0px']
         },
         {
            id:'greeting',
            type:'group',
            rect:['498','220px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['452px','126px','659px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['269px','127px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['77px','320px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
            ...
            },
            {
               ...
               },
               {
                  id:'ans3',
                  type:'rect',
                  rect:['0px','197px','212px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"]
               },
               {
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd4',
               type:'text',
               rect:['467px','0px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"CQ;ry;",
               align:"center",
            ...
            },
            {
               id:'wrd3',
               type:'text',
               rect:['12px','3px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"Crp",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['139px','3px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"Cjy;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['279px','3px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"Ch;tyk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['293px','47px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid63", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid71", tween: [ "style", "${_padangal}", "top", '205px', { fromValue: '205px'}], position: 0, duration: 0 },
            ...
            { id: "eid67", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid75", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1049, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid66", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid74", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1049, duration: 0 },
            { id: "eid73", tween: [ "style", "${_puthisali}", "left", '184px', { fromValue: '184px'}], position: 1049, duration: 0 },
            { id: "eid68", tween: [ "style", "${_words}", "left", '440px', { fromValue: '440px'}], position: 0, duration: 0 },
            ...
            { id: "eid77", tween: [ "style", "${_star}", "top", '-49px', { fromValue: '-49px'}], position: 1049, duration: 0 },
            { id: "eid7", tween: [ "style", "${_words}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid65", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid76", tween: [ "style", "${_star}", "left", '-172px', { fromValue: '-172px'}], position: 1049, duration: 0 },
            { id: "eid69", tween: [ "style", "${_words}", "top", '780px', { fromValue: '780px'}], position: 0, duration: 0 },
            { id: "eid78", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1049, duration: 0 },
