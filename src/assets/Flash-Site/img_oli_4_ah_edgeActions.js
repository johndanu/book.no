...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_appalam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('appalam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vattam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('vattam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pandham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('pandham');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thandham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thandham');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thandham}", "mouseover", function(sym, e) {
         sym.play("on_6");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vattam}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_pandham}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_appalam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_appalam}", "mouseout", function(sym, e) {
         sym.stop("off_2");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thandham}", "mouseout", function(sym, e) {
         sym.stop("off_6");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vattam}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pandham}", "mouseout", function(sym, e) {
         sym.stop("off_9");
