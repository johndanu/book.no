...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['45.8%','37%','46.5%','13.3%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['498','205px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['447px','125px','659px','34px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd2',
               type:'text',
               rect:['321px','7px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"cauk;",
               align:"center",
            ...
            },
            {
               id:'wrd1',
               type:'text',
               rect:['113px','8px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"cyfk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid65", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid77", tween: [ "style", "${_puthisali}", "top", '237px', { fromValue: '237px'}], position: 1064, duration: 0 },
            { id: "eid68", tween: [ "style", "${_padangal}", "top", '218px', { fromValue: '218px'}], position: 0, duration: 0 },
            ...
            { id: "eid64", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid72", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1064, duration: 0 },
            { id: "eid70", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid69", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid71", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1064, duration: 0 },
            { id: "eid79", tween: [ "style", "${_puthisali}", "left", '185px', { fromValue: '185px'}], position: 1064, duration: 0 },
            { id: "eid66", tween: [ "style", "${_words}", "left", '350px', { fromValue: '350px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid74", tween: [ "style", "${_star}", "top", '-46px', { fromValue: '-46px'}], position: 1064, duration: 0 },
            ...
            { id: "eid73", tween: [ "style", "${_star}", "left", '-185px', { fromValue: '-185px'}], position: 1064, duration: 0 },
            { id: "eid67", tween: [ "style", "${_words}", "top", '493px', { fromValue: '493px'}], position: 0, duration: 0 },
            { id: "eid80", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1064, duration: 0 },
