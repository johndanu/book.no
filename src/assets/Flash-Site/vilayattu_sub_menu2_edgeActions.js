...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pa}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_pa.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ma}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_ma.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ka}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_ka.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sa}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_sa.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_va}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_va.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_na}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_na.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_tha}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("matching_picture_tha.html", "_self");
             } , 2000 );
         }
