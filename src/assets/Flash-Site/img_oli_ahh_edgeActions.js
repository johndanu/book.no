...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aaram}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('aaram');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aayutham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('aayutham');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aalam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('aalam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aayutham}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aalam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aalam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aayutham}", "mouseout", function(sym, e) {
         sym.stop("off_3");
