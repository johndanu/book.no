...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['46.7%','37%','46.5%','13.3%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['483px','229px','546','502','auto','auto'],
            c:[
            {
               id:'greetings',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['449px','124px','659px','34px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'ans5',
                  type:'rect',
                  rect:['-6px','199px','212px','38px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd5',
               type:'text',
               rect:['658px','11px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"gl;lzk;",
               align:"center",
            ...
            },
            {
               id:'wrd4',
               type:'text',
               rect:['528px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"gL",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd3',
               type:'text',
               rect:['342px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"gzk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['169px','9px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"gl;lk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   states: {
      "Base State": {
         ...
         "${_star}": [
            ["style", "top", '-25px'],
            ["transform", "scaleY", '1.07394'],
            ["transform", "scaleX", '1.10122'],
            ["style", "height", '568px'],
            ["style", "display", 'none'],
            ["style", "left", '-137px'],
            ["style", "width", '817px']
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 960, duration: 0 },
            { id: "eid56", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 584, duration: 0 },
            { id: "eid62", tween: [ "style", "${_padangal}", "left", '285px', { fromValue: '285px'}], position: 584, duration: 0 },
            { id: "eid2", tween: [ "style", "${_padangal}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid55", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 584, duration: 0 },
            { id: "eid72", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1008, duration: 0 },
            { id: "eid57", tween: [ "style", "${_words}", "top", '777px', { fromValue: '777px'}], position: 584, duration: 0 },
            { id: "eid58", tween: [ "style", "${_words}", "left", '374px', { fromValue: '374px'}], position: 584, duration: 0 },
            { id: "eid20", tween: [ "style", "${_star}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid21", tween: [ "style", "${_star}", "display", 'block', { fromValue: 'none'}], position: 1008, duration: 0 },
            { id: "eid22", tween: [ "style", "${_star}", "display", 'none', { fromValue: 'block'}], position: 1034, duration: 0 },
            { id: "eid23", tween: [ "style", "${_star}", "display", 'block', { fromValue: 'none'}], position: 1061, duration: 0 },
            { id: "eid24", tween: [ "style", "${_star}", "display", 'none', { fromValue: 'block'}], position: 1087, duration: 0 },
            { id: "eid28", tween: [ "style", "${_star}", "display", 'block', { fromValue: 'none'}], position: 1123, duration: 0 },
            { id: "eid27", tween: [ "style", "${_star}", "display", 'none', { fromValue: 'block'}], position: 1189, duration: 0 },
            { id: "eid26", tween: [ "style", "${_star}", "display", 'block', { fromValue: 'none'}], position: 1227, duration: 0 },
            { id: "eid25", tween: [ "style", "${_star}", "display", 'none', { fromValue: 'block'}], position: 1262, duration: 0 },
            { id: "eid61", tween: [ "style", "${_padangal}", "top", '205px', { fromValue: '205px'}], position: 584, duration: 0 },
            { id: "eid7", tween: [ "style", "${_words}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid54", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 584, duration: 0 },
            { id: "eid52", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 584, duration: 0 },
            ...
            { id: "eid40", tween: [ "style", "${_puthisali}", "display", 'block', { fromValue: 'none'}], position: 1008, duration: 0 },
            { id: "eid36", tween: [ "color", "${_puthisali}", "color", 'rgba(157,1,251,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(251,2,2,1)'}], position: 1008, duration: 53 }         ]
      }
   }
},
"pupils": {
