         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "eluthupalagai.mp3|" + assetsPath + "eluthupalagai.ogg", id: "e_pic1"},
         
                                                {src: assetsPath + "erumbu.mp3|" + assetsPath + "erumbu.ogg", id: "e_pic2"},
         
                                                {src: assetsPath + "elli.mp3|" + assetsPath + "elli.ogg", id: 'e_pic3'},
         
                                                {src: assetsPath + "mealam.mp3|" + assetsPath + "mealam.ogg", id: 'e_pic4'},
         
                                                {src: assetsPath + "vellai.mp3|" + assetsPath + "vellaiogg", id: 'e_pic5'},
         
                                                {src: assetsPath + "sevvanthi.mp3|" + assetsPath + "sevvanthi.ogg", id: 'e_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/e_pic1.png)","url(images/e_pic2.png)","url(images/e_pic3.png)",
      						"url(images/e_pic4.png)","url(images/e_pic5.png)","url(images/e_pic6.png)"];
