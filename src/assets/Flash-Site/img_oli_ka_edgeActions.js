...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kattadam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kattadam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kappal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kappal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_karam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('karam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kadal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kadal');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kalam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kalam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kall}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kannam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kannam');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kann}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kan');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kadam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kadam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kattadam}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kattadam}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kappal}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kannam}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kann}", "mouseover", function(sym, e) {
         sym.play("on_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kadam}", "mouseover", function(sym, e) {
         sym.play("on_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kadal}", "mouseover", function(sym, e) {
         sym.play("on_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kalam}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kall}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_karam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_karam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kappal}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kannam}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kann}", "mouseout", function(sym, e) {
         sym.stop("off_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kadam}", "mouseout", function(sym, e) {
         sym.stop("off_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kadal}", "mouseout", function(sym, e) {
         sym.stop("off_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kalam}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kall}", "mouseout", function(sym, e) {
         sym.stop("off_9");
