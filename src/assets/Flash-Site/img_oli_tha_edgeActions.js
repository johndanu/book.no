...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thangam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thangam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thambi}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thambi');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thattam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thattam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thadam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thadam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thangam}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thangam}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thambi}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thadam}", "mouseover", function(sym, e) {
         sym.play("on_4");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thattam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_thattam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_thambi}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_thadam}", "mouseout", function(sym, e) {
         sym.stop("off_4");
