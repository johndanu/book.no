...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['461px','128px','659px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['269px','130px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['398px','318px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
               ...
               },
               {
                  id:'ans5',
                  type:'rect',
                  rect:['-13px','198px','212px','38px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd5',
               type:'text',
               rect:['545px','4px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"tz;zk;",
               align:"center",
            ...
            },
            {
               id:'wrd4',
               type:'text',
               rect:['-40px','10px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"tyk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd3',
               type:'text',
               rect:['397px','7px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"tl;lk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['102px','10px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"tay;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['251px','10px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"til",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid73", tween: [ "style", "${_puthisali}", "top", '236px', { fromValue: '236px'}], position: 1036, duration: 0 },
            { id: "eid69", tween: [ "style", "${_padangal}", "top", '209px', { fromValue: '209px'}], position: 0, duration: 0 },
            ...
            { id: "eid75", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1062, duration: 0 },
            { id: "eid65", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid68", tween: [ "style", "${_padangal}", "left", '293px', { fromValue: '293px'}], position: 0, duration: 0 },
            ...
            { id: "eid64", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid74", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1062, duration: 0 },
            { id: "eid62", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_words}", "left", '446px', { fromValue: '446px'}], position: 0, duration: 0 },
            { id: "eid72", tween: [ "style", "${_puthisali}", "left", '186px', { fromValue: '186px'}], position: 1036, duration: 0 },
            { id: "eid77", tween: [ "style", "${_star}", "top", '-44px', { fromValue: '-44px'}], position: 1062, duration: 0 },
            ...
            { id: "eid76", tween: [ "style", "${_star}", "left", '-179px', { fromValue: '-179px'}], position: 1062, duration: 0 },
            { id: "eid70", tween: [ "style", "${_words}", "top", '779px', { fromValue: '779px'}], position: 0, duration: 0 },
            { id: "eid78", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1062, duration: 0 },
