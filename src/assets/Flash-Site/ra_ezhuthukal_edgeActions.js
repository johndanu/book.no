         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "ra.mp3|" + assetsPath + "ra.ogg", id: "pic1"},
         
                                  {src: assetsPath + "raa.mp3|" + assetsPath + "raa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "ri.mp3|" + assetsPath + "ri.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "ree.mp3|" + assetsPath + "ree.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "ru.mp3|" + assetsPath + "ru.ogg", id: 'pic5'},
         								 {src: assetsPath + "roo.mp3|" + assetsPath + "roo.ogg", id: 'pic6'},
                                  {src: assetsPath + "re.mp3|" + assetsPath + "re.ogg", id: 'pic7'},
                                  {src: assetsPath + "rea.mp3|" + assetsPath + "rea.ogg", id: 'pic8'},
                                  {src: assetsPath + "rai.mp3|" + assetsPath + "rai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "ro.mp3|" + assetsPath + "ro.ogg", id: 'pic10'},
                                  {src: assetsPath + "rro.mp3|" + assetsPath + "rro.ogg", id: 'pic11'},
                                  {src: assetsPath + "rov.mp3|" + assetsPath + "rov.ogg", id: 'pic12'},
