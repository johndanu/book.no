...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'wrapper',
            type:'image',
            rect:['0px','109px','1366px','646px','auto','auto'],
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['446px','121px','785px','17px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['266px','120px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['398px','323px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
               ...
               },
               {
                  id:'answrd5',
                  type:'text',
                  rect:['-14px','198px','202px','53px','auto','auto'],
                  text:".. g;gk;",
                  align:"center",
               ...
               },
               {
                  id:'ansbox5',
                  type:'rect',
                  rect:['11px','197px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line5',
                  type:'text',
                  rect:['20px','190px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               id:'box4',
               type:'group',
               rect:['83px','325px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['12px','196px','auto','auto','auto','auto'],
                  text:"mg; ..",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['94px','197px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['103px','190px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box3',
               type:'group',
               rect:['718px','12px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect3',
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['27px','196px','auto','auto','auto','auto'],
                  text:"mf; ..",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox3',
                  type:'rect',
                  rect:['115px','197px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line3',
                  type:'text',
                  rect:['124px','190px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['18px','197px','auto','auto','auto','auto'],
                  text:"mz; ..",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['125px','199px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['134px','192px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box1',
               type:'group',
               rect:['77px','14px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect1',
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['15px','198px','auto','auto','auto','auto'],
                  text:"mk; .. ",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['96px','198px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['105px','191px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
   ...
   states: {
      "Base State": {
         ...
         "${_header}": [
            ...
            ["style", "opacity", '1'],
            ["style", "width", '785px'],
            ["transform", "scaleX", '1.03822']
         ],
         "${_logo_batch}": [
            ["style", "opacity", '1'],
            ["style", "left", '3.66%'],
            ["transform", "scaleY", '0.94311']
         ],
         "${_Stage}": [
            ["color", "background-color", 'rgba(255,255,255,1)'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid4", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid3", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid6", tween: [ "style", "${_letters}", "top", '765px', { fromValue: '765px'}], position: 0, duration: 0 },
            ...
            { id: "eid8", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            ...
            { id: "eid5", tween: [ "style", "${_letters}", "left", '434px', { fromValue: '434px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
