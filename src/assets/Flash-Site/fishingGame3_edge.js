   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid127", tween: [ "style", "${_TextCopy8}", "left", '62px', { fromValue: '62px'}], position: 0, duration: 0 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid128", tween: [ "style", "${_TextCopy6}", "left", '68px', { fromValue: '68px'}], position: 0, duration: 0 },
