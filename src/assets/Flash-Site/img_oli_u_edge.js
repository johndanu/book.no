...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            c:[
            {
               id:'rect_u',
               type:'rect',
               rect:['0px','-2px','80px','54px','auto','auto'],
               cursor:['pointer'],
            ...
            },
            {
               id:'text_u',
               type:'text',
               rect:['12px','1px','41px','52px','auto','auto'],
               text:"c",
               align:"left",
         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  ...
                  fill:["rgba(0,0,0,0)",im+"image%201228.png",'0px','0px']
               },
               {
                  id:'uyaram_txt',
                  type:'text',
            ...
            },
            {
               ...
               },
               {
                  id:'ulagam_img',
                  type:'image',
                  rect:['-1px','15px','268px','213px','auto','auto'],
                  fill:["rgba(0,0,0,0)",im+"image%201223.png",'0px','0px']
               },
               {
                  id:'ulagam_txt',
                  type:'text',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid116", tween: [ "style", "${_uyaram_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid23", tween: [ "style", "${_uyaram_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1152, duration: 14 },
            { id: "eid24", tween: [ "style", "${_uyaram_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1223, duration: 0 },
            { id: "eid12", tween: [ "style", "${_ulagam_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1000, duration: 14 },
            { id: "eid19", tween: [ "style", "${_ulagam_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1071, duration: 0 },
            { id: "eid114", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid14", tween: [ "color", "${_ulagam_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1000, duration: 14 },
            { id: "eid16", tween: [ "color", "${_ulagam_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1071, duration: 0 },
            { id: "eid123", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid118", tween: [ "style", "${_ulagam_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "color", "${_ulagam_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1000, duration: 14 },
            { id: "eid20", tween: [ "color", "${_ulagam_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1071, duration: 0 },
            { id: "eid115", tween: [ "style", "${_uyaram_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid117", tween: [ "style", "${_ulagam_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid25", tween: [ "color", "${_uyaram_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1152, duration: 14 },
            { id: "eid26", tween: [ "color", "${_uyaram_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1223, duration: 0 },
            { id: "eid21", tween: [ "color", "${_uyaram_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1152, duration: 14 },
            { id: "eid22", tween: [ "color", "${_uyaram_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1223, duration: 0 }         ]
      }
   }
},
"pupils": {
