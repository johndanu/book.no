...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "sura.mp3|" + assetsPath + "sura.ogg", id: "pic1"},
         
                                  {src: assetsPath + "ilaneer.mp3|" + assetsPath + "ilaneer.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "koodu.mp3|" + assetsPath + "koodu.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "meen.mp3|" + assetsPath + "meen.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "nungu.mp3|" + assetsPath + "nungu.ogg", id: 'pic5'},
         								 {src: assetsPath + "mooku.mp3|" + assetsPath + "mooku.ogg", id: 'pic6'},
                                  {src: assetsPath + "sangu.mp3|" + assetsPath + "sangu.ogg", id: 'pic7'},
                                  {src: assetsPath + "poo.mp3|" + assetsPath + "poo.ogg", id: 'pic8'},
                                  {src: assetsPath + "eesal.mp3|" + assetsPath + "eesal.ogg", id: 'pic9'},
                                  {src: assetsPath + "nool.mp3|" + assetsPath + "nool.ogg", id: 'pic10'},
                                  {src: assetsPath + "keeri.mp3|" + assetsPath + "keeri.ogg", id: 'pic11'},
                                  {src: assetsPath + "thee.mp3|" + assetsPath + "thee.ogg", id: 'pic12'},
                                  {src: assetsPath + "veedu.mp3|" + assetsPath + "veedu.ogg", id: 'pic13'},
                                  {src: assetsPath + "moonglil.mp3|" + assetsPath + "moongil", id: 'pic14'},
                                  {src: assetsPath + "veeran.mp3|" + assetsPath + "veeran", id: 'pic15'},
                                  {src: assetsPath + "sulagu.mp3|" + assetsPath + "sulagu.ogg", id: 'pic16'},
                                  {src: assetsPath + "moodi.mp3|" + assetsPath + "moodi.ogg", id: 'pic17'},
                                  {src: assetsPath + "poonga.mp3|" + assetsPath + "poonga.ogg", id: 'pic18'},
                                  {src: assetsPath + "thumbi.mp3|" + assetsPath + "thumbi.ogg", id: 'pic19'},
                                  {src: assetsPath + "aadu.mp3|" + assetsPath + "aadu.ogg", id: 'pic20'},
         ...
         sym.setVariable("myques",['Rwh',',sePh;',"$L",'kPd;','Eq;F','%f;F','rq;F','g+','<ry;','E}y;','fPhp','jP','tPL','%q;fpy;','tPud;','RsF','%b','g+q;fh','Jk;gp','ML']);
         sym.setVariable("myopt",['r2','r1',"r3",'r1','r2',"r3",'r2','r3',"r1",'r3','r1',"r1",'r1','r3',"r1",'r2','r3',"r3",'r2','r2']);
