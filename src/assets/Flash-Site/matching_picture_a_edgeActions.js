         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "amma.mp3|" +  assetsPath + "amma.ogg", id: "a_pic1"},
         
                                                {src: assetsPath + "appalam.mp3|" + assetsPath + "appalam.ogg", id: 'a_pic2'},
         
                                                {src: assetsPath + "appam.mp3|" + assetsPath + "appam.ogg", id: 'a_pic3'},
         
                                                {src: assetsPath + "anna.mp3|" + assetsPath + "anna.ogg", id: 'a_pic4'},
         
                                                {src: assetsPath + "akka.mp3|" + assetsPath + "akka.ogg", id: 'a_pic5'},
         
                                                {src: assetsPath + "appa.mp3|" + assetsPath + "appa.ogg", id: 'a_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/a_pic1.png)","url(images/a_pic2.png)","url(images/a_pic3.png)",
      						"url(images/a_pic4.png)","url(images/a_pic5.png)","url(images/a_pic6.png)"];
