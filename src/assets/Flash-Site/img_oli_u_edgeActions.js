...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ulagam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('ulagam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_uyaram}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('uyaram');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ulagam}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ulagam}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_uyaram}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_uyaram}", "mouseout", function(sym, e) {
         sym.stop("off_2");
