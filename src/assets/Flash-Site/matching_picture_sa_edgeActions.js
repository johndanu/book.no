...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/sa_pic1.png)","url(images/sa_pic2.png)","url(images/sa_pic3.png)",
      						"url(images/sa_pic4.png)","url(images/sa_pic5.png)","url(images/sa_pic6.png)"];
