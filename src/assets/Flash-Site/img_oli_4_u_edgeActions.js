...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sura}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sura');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nungu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('nungu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kudam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kudam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aadu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('aadu');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kurangu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kurangu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thumbi}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('thumbi');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sulagu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sulagu');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sangu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('sangu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_siruvan}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('siruvan');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sura}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sura}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nungu}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sulagu}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sangu}", "mouseover", function(sym, e) {
         sym.play("on_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_siruvan}", "mouseover", function(sym, e) {
         sym.play("on_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aadu}", "mouseover", function(sym, e) {
         sym.play("on_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kurangu}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_thumbi}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kudam}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kudam}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_nungu}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sulagu}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_sangu}", "mouseout", function(sym, e) {
         sym.stop("off_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_siruvan}", "mouseout", function(sym, e) {
         sym.stop("off_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aadu}", "mouseout", function(sym, e) {
         sym.stop("off_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kurangu}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_thumbi}", "mouseout", function(sym, e) {
         sym.stop("off_9");
