         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "zha.mp3|" + assetsPath + "zha.ogg", id: "pic1"},
         
                                  {src: assetsPath + "zhaa.mp3|" + assetsPath + "zhaa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "zhi.mp3|" + assetsPath + "zhi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "zhee.mp3|" + assetsPath + "zhee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "zhu.mp3|" + assetsPath + "zhu.ogg", id: 'pic5'},
         								 {src: assetsPath + "zhoo.mp3|" + assetsPath + "zhoo.ogg", id: 'pic6'},
                                  {src: assetsPath + "zhe.mp3|" + assetsPath + "zhe.ogg", id: 'pic7'},
                                  {src: assetsPath + "zhea.mp3|" + assetsPath + "zhea.ogg", id: 'pic8'},
                                  {src: assetsPath + "zhai.mp3|" + assetsPath + "zhai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "zho.mp3|" + assetsPath + "zho.ogg", id: 'pic10'},
                                  {src: assetsPath + "zzho.mp3|" + assetsPath + "zzho.ogg", id: 'pic11'},
                                  {src: assetsPath + "zhov.mp3|" + assetsPath + "zhov.ogg", id: 'pic12'},
