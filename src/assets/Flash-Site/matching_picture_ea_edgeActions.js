         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "7.mp3|" + assetsPath + "7.ogg", id: "ea_pic1"},
         
                                                {src: assetsPath + "eani.mp3|" + assetsPath + "eani.ogg", id: 'ea_pic2'},
         
                                                {src: assetsPath + "eari.mp3|" + assetsPath + "eari.ogg", id: 'ea_pic3'},
         
                                                {src: assetsPath + "thaengai.mp3|" + assetsPath + "thaengaiogg", id: 'ea_pic4'},
         
                                                {src: assetsPath + "vetti.mp3|" + assetsPath + "vetti.ogg", id: 'ea_pic5'},
         
                                                {src: assetsPath + "selai.mp3|" + assetsPath + "selai.ogg", id: 'ea_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/ea_pic1.png)","url(images/ea_pic2.png)","url(images/ea_pic3.png)",
      						"url(images/ea_pic4.png)","url(images/ea_pic5.png)","url(images/ea_pic6.png)"];
