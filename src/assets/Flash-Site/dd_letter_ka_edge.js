...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'sidecolor',
            type:'image',
            rect:['0%','-1.2%','3.7%','110.6%','auto','auto'],
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['437px','122px','768px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['268px','120px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['404px','330px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
               ...
               },
               {
                  id:'answrd5',
                  type:'text',
                  rect:['-9px','198px','202px','53px','auto','auto'],
                  text:"fl ..",
                  align:"center",
               ...
               },
               {
                  id:'ansbox5',
                  type:'rect',
                  rect:['101px','201px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line5',
                  type:'text',
                  rect:['110px','194px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               id:'box4',
               type:'group',
               rect:['80px','331px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['44px','198px','auto','auto','auto','auto'],
                  text:"f ;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['79px','201px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['88px','194px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['16px','200px','auto','auto','auto','auto'],
                  text:"fg; .  y;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['35px','200px','auto','auto','auto','auto'],
                  text:"f . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['75px','202px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['84px','195px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['-4px','199px','auto','auto','auto','auto'],
                  text:"fl;l .  k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['95px','202px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['104px','195px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
         ...
         },
         {
            ...
            c:[
            {
               id:'letter5',
               type:'text',
               rect:['474px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"y;",
               align:"center",
            ...
            },
            {
               id:'letter4',
               type:'text',
               rect:['334px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"z;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'letter3',
               type:'text',
               rect:['193px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"g",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'letter2',
               type:'text',
               rect:['53px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"u",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'letter1',
               type:'text',
               rect:['619px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"l",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['296px','38px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid46", tween: [ "style", "${_letters}", "top", '781px', { fromValue: '781px'}], position: 0, duration: 0 },
            ...
            { id: "eid44", tween: [ "style", "${_letters}", "left", '412px', { fromValue: '422px'}], position: 0, duration: 56 }         ]
      }
   }
},
"pupils": {
