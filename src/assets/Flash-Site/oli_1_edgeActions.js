...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pa}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_pa.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ma}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ma.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ka}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ka.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_sa}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_sa.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_va}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_va.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_na}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_na.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_tha}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_tha.html", "_self");
             } , 2000 );
         }
