         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "manjal.mp3|" + assetsPath + "manjal.ogg", id: "ma_pic1"},
         
                                                {src: assetsPath + "maram.mp3|" + assetsPath + "maram.ogg", id: 'ma_pic2'},
         
                                                {src: assetsPath + "mann.mp3|" + assetsPath + "mann.ogg", id: 'ma_pic3'},
         
                                                {src: assetsPath + "malai.mp3|" + assetsPath + "malai.ogg", id: 'ma_pic4'},
         
                                                {src: assetsPath + "macham.mp3|" + assetsPath + "macham.ogg", id: 'ma_pic5'},
         
                                                {src: assetsPath + "mathalam.mp3|" + assetsPath + "mathalam.ogg", id: 'ma_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/ma_pic1.png)","url(images/ma_pic2.png)","url(images/ma_pic3.png)",
      						"url(images/ma_pic4.png)","url(images/ma_pic5.png)","url(images/ma_pic6.png)"];
