         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "vadai.mp3|" + assetsPath + "vadai.ogg", id: "va_pic1"},
         
                                                {src: assetsPath + "vayal.mp3|" + assetsPath + "vayal.ogg", id: 'va_pic2'},
         
                                                {src: assetsPath + "vattam.mp3|" + assetsPath + "vattam.ogg", id: 'va_pic3'},
         
                                                {src: assetsPath + "valam.mp3|" + assetsPath + "valam.ogg", id: 'va_pic4'},
         
                                                {src: assetsPath + "vannam.mp3|" + assetsPath + "vannam.ogg", id: 'va_pic5'},
         
                                                {src: assetsPath + "vathu.mp3|" + assetsPath + "vathu.ogg", id: 'va_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/va_pic1.png)","url(images/va_pic2.png)","url(images/va_pic3.png)",
      						"url(images/va_pic4.png)","url(images/va_pic5.png)","url(images/va_pic6.png)"];
