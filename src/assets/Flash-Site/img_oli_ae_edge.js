...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'text_ae',
               type:'text',
               rect:['15px','0px','19px','34px','auto','auto'],
               text:"v",
               align:"left",
         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  ...
                  fill:["rgba(0,0,0,0)",im+"image%201273.png",'0px','0px']
               },
               {
                  id:'eli_txt',
                  type:'text',
            ...
            },
            {
               ...
               },
               {
                  ...
                  type:'image',
                  rect:['-1px','15px','267px','212px','auto','auto'],
                  fill:["rgba(0,0,0,0)",im+"image%201268.png",'0px','0px']
               },
               {
                  id:'erumbu_txt',
                  type:'text',
            ...
            },
            {
               ...
               },
               {
                  ...
                  type:'image',
                  rect:['-1px','15px','267px','212px','auto','auto'],
                  fill:["rgba(0,0,0,0)",im+"image%201263.png",'0px','0px']
               },
               {
                  id:'erudhu_txt',
                  type:'text',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid23", tween: [ "style", "${_erumbu_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1152, duration: 14 },
            { id: "eid24", tween: [ "style", "${_erumbu_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1223, duration: 0 },
            { id: "eid118", tween: [ "style", "${_erudhu_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid119", tween: [ "style", "${_erumbu_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid21", tween: [ "color", "${_erumbu_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1152, duration: 14 },
            { id: "eid22", tween: [ "color", "${_erumbu_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1223, duration: 0 },
            { id: "eid12", tween: [ "style", "${_erudhu_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1000, duration: 14 },
            { id: "eid19", tween: [ "style", "${_erudhu_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1071, duration: 0 },
            { id: "eid31", tween: [ "color", "${_eli_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1367, duration: 14 },
            { id: "eid32", tween: [ "color", "${_eli_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1438, duration: 0 },
            { id: "eid130", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid117", tween: [ "style", "${_erudhu_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid27", tween: [ "color", "${_eli_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1367, duration: 14 },
            { id: "eid28", tween: [ "color", "${_eli_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1438, duration: 0 },
            { id: "eid25", tween: [ "color", "${_erumbu_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1152, duration: 14 },
            { id: "eid26", tween: [ "color", "${_erumbu_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1223, duration: 0 },
            { id: "eid121", tween: [ "style", "${_erumbu_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid123", tween: [ "style", "${_eli_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid29", tween: [ "style", "${_eli_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1367, duration: 14 },
            { id: "eid30", tween: [ "style", "${_eli_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1438, duration: 0 },
            { id: "eid115", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid14", tween: [ "color", "${_erudhu_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1000, duration: 14 },
            { id: "eid16", tween: [ "color", "${_erudhu_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1071, duration: 0 },
            { id: "eid8", tween: [ "color", "${_erudhu_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1000, duration: 14 },
            { id: "eid20", tween: [ "color", "${_erudhu_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1071, duration: 0 },
            { id: "eid122", tween: [ "style", "${_eli_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
