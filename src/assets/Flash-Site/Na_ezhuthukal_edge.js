...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid393", tween: [ "style", "${_header}", "width", '585px', { fromValue: '585px'}], position: 0, duration: 0 },
            { id: "eid276", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid263", tween: [ "style", "${_Text3}", "height", '31px', { fromValue: '31px'}], position: 0, duration: 0 },
            { id: "eid274", tween: [ "style", "${_wrapper}", "left", '42px', { fromValue: '42px'}], position: 0, duration: 0 },
            { id: "eid187", tween: [ "style", "${_mystage}", "top", '114px', { fromValue: '114px'}], position: 0, duration: 0 },
            { id: "eid395", tween: [ "style", "${_header}", "top", '-5px', { fromValue: '-5px'}], position: 0, duration: 0 },
            { id: "eid186", tween: [ "style", "${_mystage}", "left", '266px', { fromValue: '266px'}], position: 0, duration: 0 },
            { id: "eid394", tween: [ "style", "${_header}", "left", '213px', { fromValue: '213px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
