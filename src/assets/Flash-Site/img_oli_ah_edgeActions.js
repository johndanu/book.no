...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_amma}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('amma');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_appam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('appam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_appa}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('appa');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_anna}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('anna');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_akka}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('akka');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_amma}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_amma}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_appam}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_anna}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_akka}", "mouseover", function(sym, e) {
         sym.play("on_5");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_appa}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_appa}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_appam}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_anna}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_akka}", "mouseout", function(sym, e) {
         sym.stop("off_5");
