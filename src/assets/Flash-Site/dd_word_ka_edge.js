...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['492px','219px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['454px','120px','659px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['269px','122px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['399px','325px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
               ...
               },
               {
                  id:'ans5',
                  type:'rect',
                  rect:['-12px','199px','212px','38px','auto','auto'],
            ...
            },
            {
               id:'box4',
               type:'group',
               rect:['78px','325px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
            ...
            },
            {
               id:'box3',
               type:'group',
               rect:['718px','10px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect3',
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd5',
               type:'text',
               rect:['309px','11px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"fuk;",
               align:"center",
            ...
            },
            {
               id:'wrd4',
               type:'text',
               rect:['140px','15px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"fly;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd3',
               type:'text',
               rect:['454px','9px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"fl;llk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            ...
            },
            {
               id:'wrd1',
               type:'text',
               rect:['649px','6px','auto','33px','auto','auto'],
               cursor:['pointer'],
               text:"fg;gy;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['293px','43px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid55", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid66", tween: [ "style", "${_padangal}", "top", '205px', { fromValue: '205px'}], position: 0, duration: 0 },
            ...
            { id: "eid68", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1064, duration: 0 },
            { id: "eid71", tween: [ "style", "${_puthisali}", "left", '184px', { fromValue: '184px'}], position: 1064, duration: 0 },
            { id: "eid64", tween: [ "style", "${_padangal}", "left", '294px', { fromValue: '294px'}], position: 0, duration: 0 },
            { id: "eid61", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid58", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1064, duration: 0 },
            { id: "eid57", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid62", tween: [ "style", "${_words}", "left", '415px', { fromValue: '415px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid70", tween: [ "style", "${_star}", "top", '-43px', { fromValue: '-43px'}], position: 1064, duration: 0 },
            ...
            { id: "eid69", tween: [ "style", "${_star}", "left", '-171px', { fromValue: '-171px'}], position: 1064, duration: 0 },
            { id: "eid63", tween: [ "style", "${_words}", "top", '772px', { fromValue: '772px'}], position: 0, duration: 0 },
            { id: "eid72", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1064, duration: 0 },
