...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                ...
                                {src: assetsPath + "theni.mp3|" + assetsPath + "theni.ogg", id: "pic1"},
         
                                {src: assetsPath + "kuthirai.mp3|" + assetsPath + "kuthirai.ogg", id: 'pic2'},
         
                                 {src: assetsPath + "metti.mp3|" + assetsPath + "metti.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "pachai.mp3|" + assetsPath + "pachai.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "vedi.mp3|" + assetsPath + "vedi.ogg", id: 'pic5'},
         											{src: assetsPath + "kudai.mp3|" + assetsPath + "kudai.ogg", id: 'pic6'},
                                                {src: assetsPath + "erudhu.mp3|" + assetsPath + "erudhu.ogg", id: 'pic7'},
                                                   {src: assetsPath + "seval.mp3|" + assetsPath + "seval.ogg", id: 'pic8'},
                                                      {src: assetsPath + "nell.mp3|" + assetsPath + "nell.ogg", id: 'pic9'},
                                                         {src: assetsPath + "eani.mp3|" + assetsPath + "eani.ogg", id: 'pic10'},
                                                            {src: assetsPath + "marai.mp3|" + assetsPath + "marai.ogg", id: 'pic11'},
                                                               {src: assetsPath + "velli.mp3|" + assetsPath + "velli.ogg", id: 'pic12'},
                                                               {src: assetsPath + "malai.mp3|" + assetsPath + "malai.ogg", id: 'pic13'},
                                                                  {src: assetsPath + "yanai.mp3|" + assetsPath + "yanai", id: 'pic14'},
                                                                  {src: assetsPath + "petti.mp3|" + assetsPath + "petti.ogg", id: 'pic15'},
                                                                     {src: assetsPath + "neruppu.mp3|" + assetsPath + "neruppu", id: 'pic16'},
                                                                        {src: assetsPath + "elli.mp3|" + assetsPath + "elli.ogg", id: '7'},
                                                                        {src: assetsPath + "mealam.mp3|" + assetsPath + "mealam.ogg", id: 'pic18'},
                                                                        {src: assetsPath + "vadai.mp3|" + assetsPath + "vadai.ogg", id: 'pic19'},
                                                                        {src: assetsPath + "vetti.mp3|" + assetsPath + "vetti.ogg", id: 'pic20'},
         ...
         sym.setVariable("myques",['NjdP','Fjpiu',"nkl;b",'gr;ir','ntb','Fil','vUJ','Nrty;','ney;','Vzp','kiu','Ntyp','kiy','ahid','ngl;b','neUg;G','vyp','Nksk;','til','Ntl;b']);
         sym.setVariable("myopt",['r2','r3',"r1",'r3','r1',"r3",'r1','r2',"r1",'r2','r3',"r2",'r3','r3',"r1",'r1','r1',"r2",'r3','r2']);
