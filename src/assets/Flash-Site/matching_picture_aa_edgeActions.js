         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "aaram.mp3|" + assetsPath + "aaram.ogg", id: "aa_pic1"},
         
                                                {src: assetsPath + "aalam.mp3|" + assetsPath + "aalam.ogg", id: 'aa_pic2'},
         
                                                {src: assetsPath + "aayutham.mp3|" + assetsPath + "aayutham.ogg", id: 'aa_pic3'},
         
                                                {src: assetsPath + "aandhai.mp3|" + assetsPath + "aandhai.ogg", id: 'aa_pic4'},
         
                                                {src: assetsPath + "aadu.mp3|" + assetsPath + "aadu.ogg", id: 'aa_pic5'},
         
                                                {src: assetsPath + "aamai.mp3|" + assetsPath + "aamai.ogg", id: 'aa_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/aa_pic1.png)","url(images/aa_pic2.png)","url(images/aa_pic3.png)",
      						"url(images/aa_pic4.png)","url(images/aa_pic5.png)","url(images/aa_pic6.png)"];
