         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "pa.mp3|" + assetsPath + "pa.ogg", id: "pic1"},
         
                                  {src: assetsPath + "paa.mp3|" + assetsPath + "paa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "pi.mp3|" + assetsPath + "pi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "pee.mp3|" + assetsPath + "pee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "pu.mp3|" + assetsPath + "pu.ogg", id: 'pic5'},
         								 {src: assetsPath + "poo.mp3|" + assetsPath + "poo.ogg", id: 'pic6'},
                                  {src: assetsPath + "pe.mp3|" + assetsPath + "pe.ogg", id: 'pic7'},
                                  {src: assetsPath + "pea.mp3|" + assetsPath + "pea.ogg", id: 'pic8'},
                                  {src: assetsPath + "pai.mp3|" + assetsPath + "pai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "po.mp3|" + assetsPath + "po.ogg", id: 'pic10'},
                                  {src: assetsPath + "ppo.mp3|" + assetsPath + "ppo.ogg", id: 'pic11'},
                                  {src: assetsPath + "pov.mp3|" + assetsPath + "pov.ogg", id: 'pic12'},
