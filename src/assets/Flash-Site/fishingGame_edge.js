   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid226", tween: [ "style", "${_TextCopy8}", "left", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
...
"fishh": {
   ...
   {
      font: ['MyCustomFont2',30,'rgba(255,255,255,1)','bold','none','normal'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid224", tween: [ "style", "${_TextCopy6}", "left", '67px', { fromValue: '67px'}], position: 0, duration: 0 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid225", tween: [ "style", "${_TextCopy7}", "left", '61px', { fromValue: '61px'}], position: 0, duration: 0 },
