         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'pa_txt',
                  type:'text',
                  rect:['27px','14px','auto','100px','auto','auto'],
                  text:"g",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',129,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
               }]
            },
            {
               ...
               },
               {
                  id:'ma_txt',
                  type:'text',
                  rect:['24px','14px','auto','100px','auto','auto'],
                  text:"k",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',131,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
               }]
            },
            {
               ...
               },
               {
                  id:'ka_txt',
                  type:'text',
                  rect:['23px','14px','auto','100px','auto','auto'],
                  text:"f",
                  align:"left",
            ...
            },
            {
               ...
               },
               {
                  id:'va_txt',
                  type:'text',
                  rect:['15px','6px','auto','100px','auto','auto'],
                  text:"t",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'na_txt',
                  type:'text',
                  rect:['29px','6px','auto','100px','auto','auto'],
                  text:"e",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
            ...
            },
            {
               ...
               },
               {
                  id:'tha_txt',
                  type:'text',
                  rect:['23px','6px','auto','100px','auto','auto'],
                  text:"j",
                  align:"left",
                  font:['baminiplain, Arial, sans-serif',130,"rgba(0,0,0,1)","700","none","normal"],
                  transform:[]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid396", tween: [ "style", "${_mun}", "height", '32px', { fromValue: '32px'}], position: 1308, duration: 0 },
            ...
            { id: "eid400", tween: [ "style", "${_vilayattu2Copy}", "left", '20px', { fromValue: '20px'}], position: 95, duration: 0 },
            ...
            { id: "eid404", tween: [ "style", "${_vilayattu2Copy}", "top", '-150px', { fromValue: '-581px'}], position: 95, duration: 403 },
            { id: "eid405", tween: [ "style", "${_vilayattu2Copy}", "top", '-174px', { fromValue: '-150px'}], position: 498, duration: 168 },
