...
"gameBoard": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid21", tween: [ "style", "${_flower5}", "left", '243px', { fromValue: '243px'}], position: 0, duration: 0 },
            ...
            { id: "eid23", tween: [ "style", "${_flower1}", "left", '243px', { fromValue: '243px'}], position: 0, duration: 0 },
            { id: "eid15", tween: [ "style", "${_flower3}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
            { id: "eid514", tween: [ "style", "${_flower9}", "top", '413px', { fromValue: '413px'}], position: 0, duration: 0 },
            { id: "eid19", tween: [ "style", "${_flower2}", "left", '418px', { fromValue: '418px'}], position: 0, duration: 0 },
            ...
            { id: "eid14", tween: [ "style", "${_flower11}", "left", '418px', { fromValue: '418px'}], position: 0, duration: 0 },
            { id: "eid18", tween: [ "style", "${_flower10}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
            { id: "eid445", tween: [ "transform", "${_flower11}", "scaleY", '3.373', { fromValue: '3.373'}], position: 0, duration: 0 },
            { id: "eid20", tween: [ "style", "${_flower6}", "left", '418px', { fromValue: '418px'}], position: 0, duration: 0 },
            ...
            { id: "eid24", tween: [ "style", "${_flower8}", "left", '64px', { fromValue: '64px'}], position: 0, duration: 0 },
            { id: "eid16", tween: [ "style", "${_flower7}", "left", '596px', { fromValue: '596px'}], position: 0, duration: 0 },
