...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               ...
               text:"vOj;Jf;fis fz;LgpLj;jy;<br>",
               align:"center",
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid292", tween: [ "style", "${_ee}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid295", tween: [ "style", "${_ai}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid294", tween: [ "style", "${_a}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid171", tween: [ "style", "${_menu_wrapper}", "left", '219px', { fromValue: '219px'}], position: 0, duration: 0 },
            { id: "eid299", tween: [ "style", "${_u}", "font-size", '40px', { fromValue: '40px'}], position: 0, duration: 0 },
            { id: "eid288", tween: [ "style", "${_O}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid297", tween: [ "style", "${_e}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid296", tween: [ "style", "${_o}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid300", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid286", tween: [ "style", "${_av}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid293", tween: [ "style", "${_i}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid187", tween: [ "style", "${_mystage}", "top", '114px', { fromValue: '114px'}], position: 0, duration: 0 },
            { id: "eid290", tween: [ "style", "${_ea}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
            { id: "eid298", tween: [ "style", "${_oo}", "font-size", '40px', { fromValue: '40px'}], position: 0, duration: 0 },
            { id: "eid287", tween: [ "style", "${_aa}", "font-size", '53px', { fromValue: '53px'}], position: 0, duration: 0 },
