...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ealu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('ealu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_eari}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('eari');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ealu}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ealu}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_eari}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_eari}", "mouseout", function(sym, e) {
         sym.stop("off_3");
