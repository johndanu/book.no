...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'text_ee',
               type:'text',
               rect:['17px','-1px','41px','52px','auto','auto'],
               text:"&lt;",
               align:"left",
         ...
         },
         {
            ...
            c:[
            {
               id:'eeyam',
               type:'group',
               rect:['646px','21px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'eeyam_rect',
               ...
               },
               {
                  ...
                  fill:["rgba(0,0,0,0)",im+"image%201212.png",'0px','0px']
               },
               {
                  id:'eeyam_txt',
                  type:'text',
            ...
            },
            {
               id:'eeram',
               type:'group',
               rect:['334px','21px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'eeram_rect',
               ...
               },
               {
                  ...
                  type:'image',
                  rect:['-1px','15px','267px','212px','auto','auto'],
                  fill:["rgba(0,0,0,0)",im+"image%201207.png",'0px','0px']
               },
               {
                  id:'eeram_txt',
                  type:'text',
            ...
            },
            {
               id:'eesal',
               type:'group',
               rect:['23px','21px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'eesal_rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid108", tween: [ "style", "${_eesal_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid31", tween: [ "color", "${_eeyam_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1367, duration: 14 },
            { id: "eid32", tween: [ "color", "${_eeyam_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1438, duration: 0 },
            { id: "eid109", tween: [ "style", "${_eesal_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid14", tween: [ "color", "${_eesal_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1000, duration: 14 },
            { id: "eid16", tween: [ "color", "${_eesal_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1071, duration: 0 },
            { id: "eid25", tween: [ "color", "${_eeram_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1152, duration: 14 },
            { id: "eid26", tween: [ "color", "${_eeram_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1223, duration: 0 },
            { id: "eid21", tween: [ "color", "${_eeram_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1152, duration: 14 },
            { id: "eid22", tween: [ "color", "${_eeram_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1223, duration: 0 },
            { id: "eid112", tween: [ "style", "${_eeyam_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid110", tween: [ "style", "${_eeram_rect}", "width", '284px', { fromValue: '284px'}], position: 0, duration: 0 },
            { id: "eid29", tween: [ "style", "${_eeyam_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1367, duration: 14 },
            { id: "eid30", tween: [ "style", "${_eeyam_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1438, duration: 0 },
            { id: "eid12", tween: [ "style", "${_eesal_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1000, duration: 14 },
            { id: "eid19", tween: [ "style", "${_eesal_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1071, duration: 0 },
            { id: "eid23", tween: [ "style", "${_eeram_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1152, duration: 14 },
            { id: "eid24", tween: [ "style", "${_eeram_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1223, duration: 0 },
            { id: "eid27", tween: [ "color", "${_eeyam_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1367, duration: 14 },
            { id: "eid28", tween: [ "color", "${_eeyam_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1438, duration: 0 },
            { id: "eid111", tween: [ "style", "${_eeram_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "color", "${_eesal_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1000, duration: 14 },
            { id: "eid20", tween: [ "color", "${_eesal_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1071, duration: 0 },
            { id: "eid120", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid113", tween: [ "style", "${_eeyam_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid107", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
