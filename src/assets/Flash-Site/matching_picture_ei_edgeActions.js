         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "innal.mp3|" + assetsPath + "innal.ogg", id: "ei_pic1"},
         
                                                {src: assetsPath + "illam.mp3|" + assetsPath + "illam.ogg", id: 'ei_pic2'},
         
                                                {src: assetsPath + "inbam.mp3|" + assetsPath + "inbam.ogg", id: 'ei_pic3'},
         
                                                {src: assetsPath + "ittali.mp3|" + assetsPath + "ittali.ogg", id: 'ei_pic4'},
         
                                                {src: assetsPath + "idiyappam.mp3|" + assetsPath + "kan.ogg", id: 'ei_pic5'},
         
                                                {src: assetsPath + "thavil.mp3|" + assetsPath + "thavil.ogg", id: 'ei_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/ei_pic1.png)","url(images/ei_pic2.png)","url(images/ei_pic3.png)",
      						"url(images/ei_pic4.png)","url(images/ei_pic5.png)","url(images/ei_pic6.png)"];
