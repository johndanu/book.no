...
"stage": {
   ...
   content: {
         dom: [
         {
            id:'wrapper',
            type:'image',
            rect:['-5px','0px','1370px','768px','auto','auto'],
         ...
         },
         {
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['46.9%','37%','46.5%','13.3%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'ans3',
                  type:'rect',
                  rect:['-14px','195px','212px','38px','auto','auto'],
            ...
            },
            {
               ...
               },
               {
                  id:'ans2',
                  type:'rect',
                  rect:['-15px','195px','212px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"]
               },
               {
            ...
            },
            {
               ...
               },
               {
                  id:'ans1',
                  type:'rect',
                  rect:['-19px','195px','212px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"]
               },
               {
                  id:'img1',
                  type:'image',
                  rect:['-40px','-32px','255px','212px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd3',
               type:'text',
               rect:['98px','-25px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"vyp",
               align:"center",
            ...
            },
            {
               id:'wrd2',
               type:'text',
               rect:['253px','-30px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"vWk;G",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['461px','-34px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"vUJ",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   states: {
      "Base State": {
         ...
         "${_annai_no}": [
            ["style", "-webkit-transform-origin", [50.57,46.09], {valueTemplate:'@@0@@% @@1@@%'} ],
            ["style", "-moz-transform-origin", [50.57,46.09],{valueTemplate:'@@0@@% @@1@@%'}],
            ["style", "-ms-transform-origin", [50.57,46.09],{valueTemplate:'@@0@@% @@1@@%'}],
            ["style", "msTransformOrigin", [50.57,46.09],{valueTemplate:'@@0@@% @@1@@%'}],
            ["style", "-o-transform-origin", [50.57,46.09],{valueTemplate:'@@0@@% @@1@@%'}],
            ["style", "font-weight", 'bold'],
            ["style", "left", '46.86%'],
            ["style", "font-size", '10px'],
            ["style", "top", '36.97%'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid64", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid86", tween: [ "style", "${_fct}", "top", '766px', { fromValue: '766px'}], position: 0, duration: 0 },
            { id: "eid75", tween: [ "style", "${_padangal}", "left", '298px', { fromValue: '298px'}], position: 0, duration: 0 },
            ...
            { id: "eid85", tween: [ "style", "${_fct}", "left", '56px', { fromValue: '56px'}], position: 0, duration: 0 },
            ...
            { id: "eid77", tween: [ "style", "${_words}", "left", '480px', { fromValue: '480px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid76", tween: [ "style", "${_padangal}", "top", '215px', { fromValue: '215px'}], position: 0, duration: 0 },
            { id: "eid7", tween: [ "style", "${_words}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid63", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid2", tween: [ "style", "${_padangal}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid78", tween: [ "style", "${_words}", "top", '555px', { fromValue: '555px'}], position: 0, duration: 0 },
            { id: "eid89", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1245, duration: 0 },
