...
"gameBoard": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid63", tween: [ "style", "${_flower5}", "left", '244px', { fromValue: '244px'}], position: 0, duration: 0 },
            ...
            { id: "eid57", tween: [ "style", "${_flower0}", "left", '65px', { fromValue: '65px'}], position: 0, duration: 0 },
            ...
            { id: "eid64", tween: [ "style", "${_flower10}", "left", '597px', { fromValue: '597px'}], position: 0, duration: 0 },
            { id: "eid519", tween: [ "style", "${_flower8}", "top", '413px', { fromValue: '413px'}], position: 0, duration: 0 },
            { id: "eid65", tween: [ "style", "${_flower1}", "left", '244px', { fromValue: '244px'}], position: 0, duration: 0 },
            { id: "eid56", tween: [ "style", "${_flower11}", "left", '417px', { fromValue: '417px'}], position: 0, duration: 0 },
            { id: "eid514", tween: [ "style", "${_flower9}", "top", '413px', { fromValue: '413px'}], position: 0, duration: 0 },
            { id: "eid59", tween: [ "style", "${_flower2}", "left", '417px', { fromValue: '417px'}], position: 0, duration: 0 },
            ...
            { id: "eid61", tween: [ "style", "${_flower6}", "left", '417px', { fromValue: '417px'}], position: 0, duration: 0 },
            ...
            { id: "eid58", tween: [ "style", "${_flower8}", "left", '65px', { fromValue: '65px'}], position: 0, duration: 0 },
            ...
            { id: "eid55", tween: [ "style", "${_flower7}", "left", '595px', { fromValue: '595px'}], position: 0, duration: 0 },
            { id: "eid456", tween: [ "transform", "${_flower7}", "scaleX", '3.373', { fromValue: '3.373'}], position: 0, duration: 0 },
            { id: "eid62", tween: [ "style", "${_flower4}", "left", '65px', { fromValue: '65px'}], position: 0, duration: 0 },
            { id: "eid66", tween: [ "style", "${_flower9}", "left", '244px', { fromValue: '244px'}], position: 0, duration: 0 },
            ...
            { id: "eid60", tween: [ "style", "${_flower3}", "left", '597px', { fromValue: '597px'}], position: 0, duration: 0 }         ]
      }
   }
},
"finishSym": {
