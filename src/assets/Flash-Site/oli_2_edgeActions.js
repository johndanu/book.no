...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ouu}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_uu.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ae}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ae.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aee}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_aee.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ah}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ah.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ahh}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ahh.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_e}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_e.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ee}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_ee.html", "_self");
             } , 2000 );
         }
      ...
      Symbol.bindElementAction(compId, symbolName, "${_ou}", "click", function(sym, e) {
         ...
         function delay(){
         		  setTimeout( function () {
                 window.open("img_oli_u.html", "_self");
             } , 2000 );
         }
