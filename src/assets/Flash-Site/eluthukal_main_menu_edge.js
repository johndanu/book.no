...
"stage": {
   ...
   content: {
         ...
         },
         {
            ...
            display:'none',
            type:'text',
            rect:['589px','129px','auto','auto','auto','auto'],
            text:"vOj;Jf;fs;",
            align:"left",
            font:['baminiplain, Arial, sans-serif',60,"rgba(253,123,22,1.00)","800","none","normal"]
         }],
         symbolInstances: [
         {
            id:'pupils',
   ...
   states: {
      "Base State": {
         ...
         "${_Text}": [
            ["style", "top", '119px'],
            ["color", "color", 'rgba(253,123,22,1.00)'],
            ["style", "display", 'none'],
            ["style", "left", '589px'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid701", tween: [ "style", "${_Text}", "top", '119px', { fromValue: '119px'}], position: 1863, duration: 0 },
            ...
            { id: "eid697", tween: [ "style", "${_vilayattu2}", "top", '-174px', { fromValue: '-654px'}], position: 1518, duration: 95 },
            ...
            { id: "eid698", tween: [ "style", "${_Text}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid699", tween: [ "style", "${_Text}", "display", 'block', { fromValue: 'none'}], position: 1570, duration: 0 },
