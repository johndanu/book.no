         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "va.mp3|" + assetsPath + "va.ogg", id: "pic1"},
         
                                  {src: assetsPath + "vaa.mp3|" + assetsPath + "vaa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "vi.mp3|" + assetsPath + "vi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "vee.mp3|" + assetsPath + "vee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "vu.mp3|" + assetsPath + "vu.ogg", id: 'pic5'},
         								 {src: assetsPath + "voo.mp3|" + assetsPath + "Voo.ogg", id: 'pic6'},
                                  {src: assetsPath + "Ve.mp3|" + assetsPath + "ve.ogg", id: 'pic7'},
                                  {src: assetsPath + "vea.mp3|" + assetsPath + "vea.ogg", id: 'pic8'},
                                  {src: assetsPath + "Vai.mp3|" + assetsPath + "vai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "vo.mp3|" + assetsPath + "vo.ogg", id: 'pic10'},
                                  {src: assetsPath + "vmo.mp3|" + assetsPath + "vvo.ogg", id: 'pic11'},
                                  {src: assetsPath + "vov.mp3|" + assetsPath + "vov.ogg", id: 'pic12'},
