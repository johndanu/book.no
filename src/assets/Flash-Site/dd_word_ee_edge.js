...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['496px','222px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['446px','123px','659px','34px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['77px','324px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
            ...
            },
            {
               ...
               },
               {
                  id:'img1',
                  type:'image',
                  rect:['-40px','-32px','267px','189px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd4',
               type:'text',
               rect:['491px','4px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"&lt;ak;",
               align:"center",
            ...
            },
            {
               id:'wrd2',
               type:'text',
               rect:['325px','7px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"&lt;uk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['164px','6px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"&lt;l;b",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid66", tween: [ "style", "${_fct}", "top", '834px', { fromValue: '834px'}], position: 0, duration: 0 },
            ...
            { id: "eid69", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 997, duration: 0 },
            { id: "eid65", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid68", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 997, duration: 0 },
            ...
            { id: "eid67", tween: [ "style", "${_words}", "left", '519px', { fromValue: '519px'}], position: 0, duration: 0 },
            { id: "eid61", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid73", tween: [ "style", "${_star}", "top", '-46px', { fromValue: '-46px'}], position: 997, duration: 0 },
            { id: "eid7", tween: [ "style", "${_words}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid60", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid72", tween: [ "style", "${_star}", "left", '-177px', { fromValue: '-177px'}], position: 997, duration: 0 },
            { id: "eid63", tween: [ "style", "${_words}", "top", '780px', { fromValue: '780px'}], position: 0, duration: 0 },
            { id: "eid74", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 997, duration: 0 },
