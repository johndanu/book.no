   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['47.1%','37.2%','52.6%','14.8%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['447px','127px','781px','17px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['264px','127px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['77px','334px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['8px','203px','auto','auto','auto','auto'],
                  text:",s .  H",
                  align:"center",
               ...
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['100px','200px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['109px','193px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               id:'box3',
               type:'group',
               rect:['716px','17px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect3',
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['4px','198px','auto','auto','auto','auto'],
                  text:",d; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox3',
                  type:'rect',
                  rect:['92px','199px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line3',
                  type:'text',
                  rect:['101px','192px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box2',
               type:'group',
               rect:['398px','16px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect2',
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['3px','200px','auto','auto','auto','auto'],
                  text:",y; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['85px','200px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['94px','193px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box1',
               type:'group',
               rect:['77px','16px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect1',
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['-2px','197px','auto','auto','auto','auto'],
                  text:",d; . y;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['92px','198px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['102px','189px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['296px','40px','71px','71px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid46", tween: [ "style", "${_letters}", "top", '774px', { fromValue: '774px'}], position: 56, duration: 0 },
            { id: "eid50", tween: [ "style", "${_answrd1}", "top", '200px', { fromValue: '200px'}], position: 56, duration: 0 },
            ...
            { id: "eid45", tween: [ "style", "${_letters}", "left", '432px', { fromValue: '432px'}], position: 56, duration: 0 },
            { id: "eid47", tween: [ "style", "${_ansbox1}", "left", '93px', { fromValue: '93px'}], position: 56, duration: 0 },
            ...
            { id: "eid51", tween: [ "style", "${_ansbox1}", "top", '201px', { fromValue: '201px'}], position: 56, duration: 0 },
            { id: "eid48", tween: [ "style", "${_fill_line1}", "left", '103px', { fromValue: '103px'}], position: 56, duration: 0 },
            ...
            { id: "eid42", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 56, duration: 0 },
            { id: "eid53", tween: [ "style", "${_answrd1}", "left", '4px', { fromValue: '4px'}], position: 56, duration: 0 },
            { id: "eid43", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 56, duration: 0 },
            { id: "eid58", tween: [ "style", "${_fill_line1}", "top", '195px', { fromValue: '195px'}], position: 56, duration: 0 },
            { id: "eid59", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 56, duration: 0 },
