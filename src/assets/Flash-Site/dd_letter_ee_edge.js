...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['251px','126px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['79px','334px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['44px','203px','auto','auto','auto','auto'],
                  text:"&lt;l;",
                  align:"center",
               ...
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['104px','200px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['113px','193px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               id:'box3',
               type:'group',
               rect:['718px','22px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect3',
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['34px','196px','auto','auto','auto','auto'],
                  text:"&lt; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox3',
                  type:'rect',
                  rect:['64px','196px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line3',
                  type:'text',
                  rect:['73px','190px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box2',
               type:'group',
               rect:['398px','22px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect2',
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['38px','205px','auto','auto','auto','auto'],
                  text:"&lt; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['67px','205px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['76px','198px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               ...
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['62px','199px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['71px','192px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid50", tween: [ "style", "${_answrd2}", "top", '198px', { fromValue: '198px'}], position: 56, duration: 0 },
            ...
            { id: "eid45", tween: [ "style", "${_letters}", "top", '780px', { fromValue: '780px'}], position: 56, duration: 0 },
            { id: "eid51", tween: [ "style", "${_fill_line2}", "top", '191px', { fromValue: '191px'}], position: 56, duration: 0 },
            ...
            { id: "eid49", tween: [ "style", "${_ansbox2}", "top", '198px', { fromValue: '198px'}], position: 56, duration: 0 },
            ...
            { id: "eid44", tween: [ "style", "${_letters}", "left", '422px', { fromValue: '422px'}], position: 56, duration: 0 }         ]
      }
   }
},
"pupils": {
