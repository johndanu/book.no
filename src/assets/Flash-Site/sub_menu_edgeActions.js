...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m3}", "mouseover", function(sym, e) {
         sym.play("b3_on");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m3}", "mouseout", function(sym, e) {
         sym.play("b3_off");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m4}", "mouseover", function(sym, e) {
         sym.play("b4_on");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m4}", "mouseout", function(sym, e) {
         sym.play("b4_off");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m3}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
      ...
      Symbol.bindElementAction(compId, symbolName, "${_m4}", "click", function(sym, e) {
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute for a new window)
