         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                                ...
                                                {src: assetsPath + "naham.mp3|" + assetsPath + "naham.ogg", id: "na_pic1"},
         
                                                {src: assetsPath + "nagaram.mp3|" + assetsPath + "nagaram.ogg", id: 'na_pic2'},
         
                                                {src: assetsPath + "nadanam.mp3|" + assetsPath + "nadanam.ogg", id: 'na_pic3'},
         
                                                {src: assetsPath + "nada.mp3|" + assetsPath + "nada.ogg", id: 'na_pic4'},
         
                                                {src: assetsPath + "narkaali.mp3|" + assetsPath + "narkaali.ogg", id: 'na_pic5'},
         
                                                {src: assetsPath + "nadhasuram.mp3|" + assetsPath + "nadhasuram.ogg", id: 'na_pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/na_pic1.png)","url(images/na_pic2.png)","url(images/na_pic3.png)",
      						"url(images/na_pic4.png)","url(images/na_pic5.png)","url(images/na_pic6.png)"];
