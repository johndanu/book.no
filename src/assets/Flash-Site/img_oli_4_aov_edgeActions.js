...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vavval}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('vavval');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kouthari}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('kouthari');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pournami}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('pournami');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aovdatham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oadatham');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aovayar}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('oavayar');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vavval}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_vavval}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_kouthari}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_aovdatham}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aovayar}", "mouseover", function(sym, e) {
         sym.play("on_5");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_pournami}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_pournami}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_kouthari}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aovdatham}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_aovayar}", "mouseout", function(sym, e) {
         sym.stop("off_5");
