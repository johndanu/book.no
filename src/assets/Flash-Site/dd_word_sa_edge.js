...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['487px','213px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['269px','125px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            },
            {
               ...
               },
               {
                  id:'ans3',
                  type:'rect',
                  rect:['-14px','197px','212px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"]
               },
               {
            ...
            },
            {
               ...
               },
               {
                  id:'ans1',
                  type:'rect',
                  rect:['-18px','197px','212px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"]
               },
               {
         ...
         },
         {
            ...
            c:[
            {
               id:'wrd5',
               type:'text',
               rect:['621px','7px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"rq;F",
               align:"center",
            ...
            },
            {
               id:'wrd4',
               type:'text',
               rect:['-66px','6px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"rj;jk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd3',
               type:'text',
               rect:['479px','6px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"ruk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['102px','8px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:"rl;lk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['271px','6px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:"ryq;if",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['293px','45px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid64", tween: [ "style", "${_padangal}", "top", '204px', { fromValue: '204px'}], position: 0, duration: 0 },
            ...
            { id: "eid59", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid65", tween: [ "style", "${_padangal}", "left", '296px', { fromValue: '296px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1057, duration: 0 },
            { id: "eid60", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid66", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1057, duration: 0 },
            ...
            { id: "eid62", tween: [ "style", "${_words}", "left", '452px', { fromValue: '452px'}], position: 0, duration: 0 },
            { id: "eid61", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid69", tween: [ "style", "${_star}", "top", '-43px', { fromValue: '-43px'}], position: 1057, duration: 0 },
            ...
            { id: "eid68", tween: [ "style", "${_star}", "left", '-173px', { fromValue: '-173px'}], position: 1057, duration: 0 },
            { id: "eid63", tween: [ "style", "${_words}", "top", '780px', { fromValue: '780px'}], position: 0, duration: 0 },
            { id: "eid70", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1057, duration: 0 },
