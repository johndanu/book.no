...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nel}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('nell');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_metti}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('metti');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_katterumbu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('katterumbu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_erudhu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('erudhu');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_seruppu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('seruppu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_neruppu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('neruppu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_petti}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('petti');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_vedi}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('vedi');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_eli}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('eli');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nel}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nel}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_metti}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_petti}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_vedi}", "mouseover", function(sym, e) {
         sym.play("on_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_eli}", "mouseover", function(sym, e) {
         sym.play("on_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_erudhu}", "mouseover", function(sym, e) {
         sym.play("on_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_seruppu}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_neruppu}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_katterumbu}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_katterumbu}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_metti}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_petti}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_vedi}", "mouseout", function(sym, e) {
         sym.stop("off_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_eli}", "mouseout", function(sym, e) {
         sym.stop("off_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_erudhu}", "mouseout", function(sym, e) {
         sym.stop("off_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_seruppu}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_neruppu}", "mouseout", function(sym, e) {
         sym.stop("off_9");
