...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid265", tween: [ "style", "${_header}", "width", '559px', { fromValue: '559px'}], position: 0, duration: 0 },
            { id: "eid268", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid264", tween: [ "style", "${_wrapper}", "top", '94px', { fromValue: '94px'}], position: 0, duration: 0 },
            { id: "eid267", tween: [ "style", "${_pin}", "top", '120px', { fromValue: '120px'}], position: 0, duration: 0 },
            { id: "eid171", tween: [ "style", "${_menu_wrapper}", "left", '219px', { fromValue: '219px'}], position: 0, duration: 0 },
            { id: "eid263", tween: [ "style", "${_wrapper}", "left", '25px', { fromValue: '25px'}], position: 0, duration: 0 },
            ...
            { id: "eid266", tween: [ "style", "${_header}", "left", '229px', { fromValue: '229px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
