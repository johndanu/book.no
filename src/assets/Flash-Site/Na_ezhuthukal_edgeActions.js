         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "Na.mp3|" + assetsPath + "Na.ogg", id: "pic1"},
         
                                  {src: assetsPath + "Naa.mp3|" + assetsPath + "Naa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "Ni.mp3|" + assetsPath + "Ni.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "Nee.mp3|" + assetsPath + "Nee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "Nu.mp3|" + assetsPath + "Nu.ogg", id: 'pic5'},
         								 {src: assetsPath + "Noo.mp3|" + assetsPath + "Noo.ogg", id: 'pic6'},
                                  {src: assetsPath + "Ne.mp3|" + assetsPath + "Ne.ogg", id: 'pic7'},
                                  {src: assetsPath + "Nea.mp3|" + assetsPath + "Nea.ogg", id: 'pic8'},
                                  {src: assetsPath + "Nai.mp3|" + assetsPath + "Nai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "No.mp3|" + assetsPath + "No.ogg", id: 'pic10'},
                                  {src: assetsPath + "Nto.mp3|" + assetsPath + "Nno.ogg", id: 'pic11'},
                                  {src: assetsPath + "Nov.mp3|" + assetsPath + "Nov.ogg", id: 'pic12'},
