...
"stage": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid274", tween: [ "style", "${_header}", "width", '595px', { fromValue: '595px'}], position: 0, duration: 0 },
            { id: "eid263", tween: [ "style", "${_finish}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid273", tween: [ "style", "${_wrapper}", "top", '95px', { fromValue: '95px'}], position: 0, duration: 0 },
            { id: "eid276", tween: [ "style", "${_header}", "top", '-5px', { fromValue: '-5px'}], position: 0, duration: 0 },
            { id: "eid187", tween: [ "style", "${_mystage}", "top", '114px', { fromValue: '114px'}], position: 0, duration: 0 },
            { id: "eid269", tween: [ "style", "${_wrapper}", "left", '36px', { fromValue: '36px'}], position: 0, duration: 0 },
            ...
            { id: "eid275", tween: [ "style", "${_header}", "left", '214px', { fromValue: '214px'}], position: 0, duration: 0 }         ]
      }
   }
},
"pupils": {
