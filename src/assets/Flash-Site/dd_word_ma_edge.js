...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['525px','235px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['465px','131px','659px','34px','auto','auto'],
         ...
         },
         {
            id:'pin',
            type:'group',
            rect:['269px','134px','192','39','auto','auto'],
            cursor:['pointer'],
            c:[
            {
               id:'fwd',
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['401px','320px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
            ...
            },
            {
               ...
               },
               {
                  ...
                  type:'image',
                  rect:['-40px','-32px','267px','222px','auto','auto'],
                  fill:["rgba(0,0,0,0)",im+"image%201966.jpg",'0px','0px']
               }]
            }]
         },
         {
            ...
            c:[
            {
               id:'wrd5',
               type:'text',
               rect:['317px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"kyh;",
               align:"center",
            ...
            },
            {
               id:'wrd4',
               type:'text',
               rect:['132px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"kiy",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd3',
               type:'text',
               rect:['494px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"kz;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['-28px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"kuk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['638px','8px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"kd;dd;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['293px','49px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid58", tween: [ "style", "${_padangal}", "top", '209px', { fromValue: '209px'}], position: 0, duration: 0 },
            ...
            { id: "eid62", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 996, duration: 0 },
            { id: "eid54", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid61", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 996, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid56", tween: [ "style", "${_words}", "left", '450px', { fromValue: '450px'}], position: 0, duration: 0 },
            { id: "eid53", tween: [ "style", "${_padangal}", "height", '426px', { fromValue: '426px'}], position: 0, duration: 0 },
            { id: "eid68", tween: [ "style", "${_star}", "top", '-60px', { fromValue: '-60px'}], position: 996, duration: 0 },
            { id: "eid7", tween: [ "style", "${_words}", "display", 'none', { fromValue: 'block'}], position: 900, duration: 0 },
            { id: "eid60", tween: [ "style", "${_fct}", "top", '831px', { fromValue: '831px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_star}", "left", '-188px', { fromValue: '-188px'}], position: 996, duration: 0 },
            { id: "eid57", tween: [ "style", "${_words}", "top", '780px', { fromValue: '780px'}], position: 0, duration: 0 },
            { id: "eid69", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 996, duration: 0 },
