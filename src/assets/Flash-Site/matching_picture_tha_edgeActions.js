   ...
   (function(symbolName) {
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         yepnope({
                  ...
                  var assetsPath = "sound/mathcing/";
         
                  EC.Sound.setup(
         
                             [
         
                                                {src: assetsPath + "kattadam.mp3|" + assetsPath + "kattadam.ogg", id: "pic1"},
         
                                                {src: assetsPath + "karam.mp3|" + assetsPath + "karam.ogg", id: 'pic2'},
         
                                                {src: assetsPath + "kappal.mp3|" + assetsPath + "kappal.ogg", id: 'pic3'},
         
                                                {src: assetsPath + "kannam.mp3|" + assetsPath + "kannam.ogg", id: 'pic4'},
         
                                                {src: assetsPath + "kan.mp3|" + assetsPath + "kan.ogg", id: 'pic5'},
         
                                                {src: assetsPath + "kadam.mp3|" + assetsPath + "kadam.ogg", id: 'pic6'},
...
function delay2(){
  ...
  EC.Sound.play(filename);
   ...
   (function(symbolName) {   
      ...
      var imageArray = ["url(images/tha_pic1.png)","url(images/tha_pic2.png)","url(images/tha_pic3.png)",
      						"url(images/tha_pic4.png)","url(images/tha_pic5.png)","url(images/tha_pic6.png)"];
