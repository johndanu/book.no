...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_suriyan}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('suriyan');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nool}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('nool');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mooku}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('mooku');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_moongil}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('moongil');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_moodi}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('moodi');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_koodu}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('koodu');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_poo}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('poo');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_baloon}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('baloon');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_poonga}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('poonga');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_suriyan}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_suriyan}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_nool}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_poo}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_baloon}", "mouseover", function(sym, e) {
         sym.play("on_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_poonga}", "mouseover", function(sym, e) {
         sym.play("on_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_moongil}", "mouseover", function(sym, e) {
         sym.play("on_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_moodi}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_koodu}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mooku}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mooku}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_nool}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_poo}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_baloon}", "mouseout", function(sym, e) {
         sym.stop("off_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_poonga}", "mouseout", function(sym, e) {
         sym.stop("off_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_moongil}", "mouseout", function(sym, e) {
         sym.stop("off_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_moodi}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_koodu}", "mouseout", function(sym, e) {
         sym.stop("off_9");
