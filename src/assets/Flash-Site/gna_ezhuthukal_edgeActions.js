         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "gna.mp3|" + assetsPath + "gna.ogg", id: "pic1"},
         
                                  {src: assetsPath + "gnaa.mp3|" + assetsPath + "gnaa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "gni.mp3|" + assetsPath + "gni.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "gnee.mp3|" + assetsPath + "gnee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "gnu.mp3|" + assetsPath + "gnu.ogg", id: 'pic5'},
         								 {src: assetsPath + "gnoo.mp3|" + assetsPath + "gnoo.ogg", id: 'pic6'},
                                  {src: assetsPath + "gne.mp3|" + assetsPath + "gnge.ogg", id: 'pic7'},
                                  {src: assetsPath + "gnea.mp3|" + assetsPath + "gnea.ogg", id: 'pic8'},
                                  {src: assetsPath + "gnai.mp3|" + assetsPath + "gnai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "gno.mp3|" + assetsPath + "gno.ogg", id: 'pic10'},
                                  {src: assetsPath + "ggngo.mp3|" + assetsPath + "ggno.ogg", id: 'pic11'},
                                  {src: assetsPath + "gnov.mp3|" + assetsPath + "gnov.ogg", id: 'pic12'},
