         ...
         yepnope({
                  ...
                  EC.Sound.setup(
                             ...
                             [
                                  ...
                                  {src: assetsPath + "ma.mp3|" + assetsPath + "ma.ogg", id: "pic1"},
         
                                  {src: assetsPath + "maa.mp3|" + assetsPath + "maa.ogg", id: 'pic2'},
         
                                  {src: assetsPath + "mi.mp3|" + assetsPath + "mi.ogg", id: 'pic3'},
         
                                  {src: assetsPath + "mee.mp3|" + assetsPath + "mee.ogg", id: 'pic4'},
         
                                  {src: assetsPath + "mu.mp3|" + assetsPath + "mu.ogg", id: 'pic5'},
         								 {src: assetsPath + "moo.mp3|" + assetsPath + "moo.ogg", id: 'pic6'},
                                  {src: assetsPath + "me.mp3|" + assetsPath + "me.ogg", id: 'pic7'},
                                  {src: assetsPath + "mea.mp3|" + assetsPath + "mea.ogg", id: 'pic8'},
                                  {src: assetsPath + "mai.mp3|" + assetsPath + "mai.ogg", id: 'pic9'},
         
                                  {src: assetsPath + "mo.mp3|" + assetsPath + "mo.ogg", id: 'pic10'},
                                  {src: assetsPath + "mmo.mp3|" + assetsPath + "mmo.ogg", id: 'pic11'},
                                  {src: assetsPath + "mov.mp3|" + assetsPath + "mov.ogg", id: 'pic12'},
