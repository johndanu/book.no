...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_madam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('madam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mann}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('mann');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_maram}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('maram');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_malar}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('malar');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_manjal}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('manjal');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mannan}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('mannan');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_malai}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('malai');
         sound.play();

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_maccham}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('macham');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mathalam}", "click", function(sym, e) {
         var sound = soundManager.getSoundById('mathalam');
         sound.play();
      ...
      Symbol.bindElementAction(compId, symbolName, "${_madam}", "mouseover", function(sym, e) {
         sym.play("on_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_madam}", "mouseout", function(sym, e) {
         sym.stop("off_1");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mann}", "mouseover", function(sym, e) {
         sym.play("on_3");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_malai}", "mouseover", function(sym, e) {
         sym.play("on_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_maccham}", "mouseover", function(sym, e) {
         sym.play("on_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mathalam}", "mouseover", function(sym, e) {
         sym.play("on_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_malar}", "mouseover", function(sym, e) {
         sym.play("on_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_manjal}", "mouseover", function(sym, e) {
         sym.play("on_8");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mannan}", "mouseover", function(sym, e) {
         sym.play("on_9");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_maram}", "mouseover", function(sym, e) {
         sym.play("on_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_maram}", "mouseout", function(sym, e) {
         sym.stop("off_2");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mann}", "mouseout", function(sym, e) {
         sym.stop("off_3");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_malai}", "mouseout", function(sym, e) {
         sym.stop("off_4");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_maccham}", "mouseout", function(sym, e) {
         sym.stop("off_5");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_mathalam}", "mouseout", function(sym, e) {
         sym.stop("off_6");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_malar}", "mouseout", function(sym, e) {
         sym.stop("off_7");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${_manjal}", "mouseout", function(sym, e) {
         sym.stop("off_8");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_mannan}", "mouseout", function(sym, e) {
         sym.stop("off_9");
