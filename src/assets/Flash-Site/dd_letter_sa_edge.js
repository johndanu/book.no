   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'rights',
               type:'text',
               rect:['47.7%','51.4%','60.5%','13.3%','auto','auto'],
               opacity:1,
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['47.8%','37.2%','52.6%','14.8%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['438px','123px','782px','34px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'box5',
               type:'group',
               rect:['405px','332px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect5',
               ...
               },
               {
                  id:'answrd5',
                  type:'text',
                  rect:['-19px','197px','227px','53px','auto','auto'],
                  text:"r . q;if",
                  align:"center",
               ...
               },
               {
                  id:'ansbox5',
                  type:'rect',
                  rect:['28px','198px','46px','38px','auto','auto'],
               ...
               },
               {
                  id:'fill_line5',
                  type:'text',
                  rect:['37px','191px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
            ...
            },
            {
               id:'box4',
               type:'group',
               rect:['83px','328px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
                  type:'rect',
                  rect:['-51px','-42px','280px','290px','auto','auto'],
                  sizeRange:['0px','','',''],
                  borderRadius:["10px 0px","10px 0px","25px 26px","25px 25px"],
                  fill:["rgba(255,255,255,1.00)"],
                  stroke:[2,"rgb(179, 179, 179)","solid"],
               ...
               },
               {
                  id:'answrd4',
                  type:'text',
                  rect:['26px','200px','auto','auto','auto','auto'],
                  text:"r .; F",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox4',
                  type:'rect',
                  rect:['61px','201px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line4',
                  type:'text',
                  rect:['70px','194px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box3',
               type:'group',
               rect:['718px','10px','227','189px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect3',
               ...
               },
               {
                  id:'answrd3',
                  type:'text',
                  rect:['18px','201px','auto','auto','auto','auto'],
                  text:"rj; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox3',
                  type:'rect',
                  rect:['89px','196px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line3',
                  type:'text',
                  rect:['98px','189px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box2',
               type:'group',
               rect:['398px','10px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect2',
               ...
               },
               {
                  id:'answrd2',
                  type:'text',
                  rect:['18px','200px','auto','auto','auto','auto'],
                  text:"rl; . k;",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox2',
                  type:'rect',
                  rect:['80px','194px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line2',
                  type:'text',
                  rect:['89px','187px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
            ...
            },
            {
               id:'box1',
               type:'group',
               rect:['77px','10px','288px','294px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect1',
               ...
               },
               {
                  id:'answrd1',
                  type:'text',
                  rect:['30px','199px','auto','auto','auto','auto'],
                  text:"ru .<br>",
                  align:"center",
                  font:['baminiplain, Arial, sans-serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
               {
                  id:'ansbox1',
                  type:'rect',
                  rect:['88px','196px','46px','38px','auto','auto'],
                  fill:["rgba(245,205,160,1.00)"],
                  stroke:[2,"rgba(245,205,160,1.00)","solid"]
               },
               {
                  id:'fill_line1',
                  type:'text',
                  rect:['97px','189px','auto','51px','auto','auto'],
                  text:"_",
                  align:"center",
                  font:['Georgia, Times New Roman, Times, serif',45,"rgba(0,0,0,1)","bold","none","normal"]
               },
         ...
         },
         {
            ...
            c:[
            {
               id:'letter5',
               type:'text',
               rect:['77px','10px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"y",
               align:"center",
            ...
            },
            {
               id:'letter3',
               type:'text',
               rect:['536px','2px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"j",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'letter2',
               type:'text',
               rect:['204px','10px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"l<br>",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'letter1',
               type:'text',
               rect:['357px','9px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:"k;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid45", tween: [ "style", "${_letters}", "top", '777px', { fromValue: '777px'}], position: 0, duration: 0 },
            ...
            { id: "eid46", tween: [ "style", "${_padangal}", "top", '198px', { fromValue: '198px'}], position: 0, duration: 0 },
            ...
            { id: "eid47", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid43", tween: [ "style", "${_letters}", "left", '412px', { fromValue: '422px'}], position: 0, duration: 56 }         ]
      }
   }
},
"pupils": {
