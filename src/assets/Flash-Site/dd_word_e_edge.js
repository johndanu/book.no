   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'annai_no',
               type:'text',
               rect:['52.5%','37%','46.5%','13.3%','auto','auto'],
               opacity:1,
               text:"Annai.no © 2013",
         ...
         },
         {
            id:'greeting',
            type:'group',
            rect:['498','210px','546','502','auto','auto'],
            c:[
            {
               id:'star',
               display:'none',
         ...
         },
         {
            id:'header',
            type:'text',
            rect:['450px','123px','659px','34px','auto','auto'],
         ...
         },
         {
            ...
            c:[
            {
               id:'box4',
               type:'group',
               rect:['78px','321px','290px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect4',
               ...
               },
               {
                  id:'ans4',
                  type:'rect',
                  rect:['-21px','198px','212px','38px','auto','auto'],
            ...
            },
            {
               id:'box2',
               type:'group',
               rect:['398px','10px','90px','295px','auto','auto'],
               cursor:['pointer'],
               c:[
               {
                  id:'rect2',
         ...
         },
         {
            ...
            },
            {
               id:'wrd3',
               type:'text',
               rect:['289px','7px','auto','auto','auto','auto'],
               cursor:['pointer'],
               text:",y;yk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd2',
               type:'text',
               rect:['471px','4px','auto','26px','auto','auto'],
               cursor:['pointer'],
               text:",d;dy;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
            },
            {
               id:'wrd1',
               type:'text',
               rect:['122px','10px','auto','17px','auto','auto'],
               cursor:['pointer'],
               text:",d;gk;",
               align:"center",
               font:['baminiplain, Arial, sans-serif',40,"rgba(0,0,0,1)","bold","none","normal"]
         ...
         },
         {
            id:'home',
            type:'image',
            rect:['293px','44px','71px','71px','auto','auto'],
            cursor:['pointer'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid76", tween: [ "style", "${_puthisali}", "top", '239px', { fromValue: '239px'}], position: 1152, duration: 0 },
            { id: "eid63", tween: [ "style", "${_padangal}", "top", '200px', { fromValue: '200px'}], position: 0, duration: 0 },
            ...
            { id: "eid71", tween: [ "style", "${_star}", "height", '610px', { fromValue: '610px'}], position: 1152, duration: 0 },
            { id: "eid75", tween: [ "style", "${_puthisali}", "left", '182px', { fromValue: '182px'}], position: 1152, duration: 0 },
            { id: "eid64", tween: [ "style", "${_padangal}", "left", '281px', { fromValue: '281px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "style", "${_greetings}", "display", 'block', { fromValue: 'none'}], position: 948, duration: 0 },
            { id: "eid65", tween: [ "style", "${_fct}", "left", '58px', { fromValue: '58px'}], position: 0, duration: 0 },
            { id: "eid70", tween: [ "style", "${_star}", "width", '900px', { fromValue: '900px'}], position: 1152, duration: 0 },
            { id: "eid59", tween: [ "style", "${_padangal}", "width", '950px', { fromValue: '950px'}], position: 0, duration: 0 },
            { id: "eid61", tween: [ "style", "${_words}", "left", '496px', { fromValue: '496px'}], position: 0, duration: 0 },
            { id: "eid67", tween: [ "style", "${_fct}", "top", '834px', { fromValue: '834px'}], position: 0, duration: 0 },
            { id: "eid74", tween: [ "style", "${_star}", "top", '-41px', { fromValue: '-41px'}], position: 1152, duration: 0 },
            ...
            { id: "eid72", tween: [ "style", "${_star}", "left", '-182px', { fromValue: '-182px'}], position: 1152, duration: 0 },
            { id: "eid62", tween: [ "style", "${_words}", "top", '774px', { fromValue: '774px'}], position: 0, duration: 0 },
            { id: "eid77", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 1152, duration: 0 },
