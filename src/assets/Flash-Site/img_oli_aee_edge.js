   ...
   content: {
         ...
         },
         {
            ...
            },
            {
               id:'text_aee',
               type:'text',
               rect:['13px','-5px','19px','34px','auto','auto'],
               text:"V",
               align:"left",
         ...
         },
         {
            ...
            c:[
            {
               ...
               },
               {
                  id:'eari_img',
                  type:'image',
                  rect:['3px','15px','267px','212px','auto','auto'],
            ...
            },
            {
               ...
               },
               {
                  id:'ealu_img',
                  type:'image',
                  rect:['2px','15px','267px','212px','auto','auto'],
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid126", tween: [ "style", "${_ealu_rect}", "width", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid14", tween: [ "color", "${_ealu_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1000, duration: 14 },
            { id: "eid16", tween: [ "color", "${_ealu_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1071, duration: 0 },
            { id: "eid130", tween: [ "style", "${_erumbu_rect}", "width", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid141", tween: [ "style", "${_eari_txt}", "left", '104px', { fromValue: '104px'}], position: 0, duration: 0 },
            { id: "eid29", tween: [ "style", "${_eari_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1367, duration: 14 },
            { id: "eid30", tween: [ "style", "${_eari_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1438, duration: 0 },
            { id: "eid134", tween: [ "style", "${_eari_rect}", "width", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid125", tween: [ "style", "${_ealu_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid122", tween: [ "style", "${_fct}", "display", 'block', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid142", tween: [ "style", "${_pupils}", "display", 'block', { fromValue: 'block'}], position: 0, duration: 0 },
            { id: "eid12", tween: [ "style", "${_ealu_rect}", "border-width", '3px', { fromValue: '2px'}], position: 1000, duration: 14 },
            { id: "eid19", tween: [ "style", "${_ealu_rect}", "border-width", '2px', { fromValue: '3px'}], position: 1071, duration: 0 },
            ...
            { id: "eid129", tween: [ "style", "${_erumbu_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid27", tween: [ "color", "${_eari_txt}", "color", 'rgba(210,15,255,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(0,0,0,1)'}], position: 1367, duration: 14 },
            { id: "eid28", tween: [ "color", "${_eari_txt}", "color", 'rgba(0,0,0,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(210,15,255,1.00)'}], position: 1438, duration: 0 },
            { id: "eid133", tween: [ "style", "${_eari_rect}", "height", '290px', { fromValue: '290px'}], position: 0, duration: 0 },
            { id: "eid8", tween: [ "color", "${_ealu_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1000, duration: 14 },
            { id: "eid20", tween: [ "color", "${_ealu_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1071, duration: 0 },
            { id: "eid31", tween: [ "color", "${_eari_rect}", "border-color", 'rgba(255,0,0,1.00)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(179,179,179,1)'}], position: 1367, duration: 14 },
            { id: "eid32", tween: [ "color", "${_eari_rect}", "border-color", 'rgba(179,179,179,1)', { animationColorSpace: 'RGB', valueTemplate: undefined, fromValue: 'rgba(255,0,0,1.00)'}], position: 1438, duration: 0 }         ]
      }
   }
},
"pupils": {
